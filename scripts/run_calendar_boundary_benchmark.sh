...
output_name="calendar-boundary-${safe_revision}-${safe_device}"
...
drive_args=(
  ...
  --target integration_test/calendar_boundary_performance_test.dart
  --dart-define CALENDAR_BOUNDARY_BENCHMARK=true
  ...
  --dart-define "CALENDAR_BENCHMARK_SCENARIO_FILTER=${CALENDAR_BENCHMARK_SCENARIO_FILTER:-}"
)
