...
def main() -> None:
    ...
    report = {
        ...
        "explained_context_differences": [
            ...
            },
            {
                ...
                "difference": "The HTML capture uses Djed's older 0.71 layered host, forced 30 px practice peek, and decorative inner handle. Production now uses Follow the Sky's 0.58 standard host, the shared frame's computed foreground start, and only the outer host handle.",
                "reason": "The user's September 13 correction explicitly supersedes the older Djed sheet composition while retaining its artwork, palette, copy, actions, footer, and single shared content scroll.",
            },
            {
    ...
    lines = [
        ...
        "- The September 13 Djed correction supersedes the HTML's older `.71` layered host, forced 30 px practice peek, and decorative inner handle. Production uses Follow the Sky's `.58` standard host, the shared frame's computed foreground start, and one outer handle while preserving Djed's artwork, styling, content, actions, footer, and single shared scroll.",
