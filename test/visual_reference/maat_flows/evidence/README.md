...
Six additional goldens cover product states the HTML does not author as one capture: Djed's mixed support-condition palette, its approved fourth Discovery card, Reading House's one-reader/ended-sheet safety states, active Inbox room multiplicity, and a redundant component-frame capture of Djed's authored raised state. They are supplemental regression contracts, not mockup-fidelity evidence.
