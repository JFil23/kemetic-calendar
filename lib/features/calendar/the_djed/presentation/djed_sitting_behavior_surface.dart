...
@immutable
class DjedSittingBehaviorActions {
  const DjedSittingBehaviorActions({
    required this.onMoveChanged,
    required this.onDoToday,
    required this.onResultSelected,
    required this.onResultNoteChanged,
    required this.onSmallerMoveChanged,
    required this.onCloseBeam,
...
typedef DjedSittingBehaviorBuilder =
    Widget Function(
      BuildContext context,
      DjedDayVisualFixture fixture,
      DjedSittingBehaviorActions actions,
    );

/// Owns Djed draft, result, completion, and raising behavior without choosing
/// either the Day View or detail-entry presentation.
class DjedSittingBehaviorSurface extends StatefulWidget {
  const DjedSittingBehaviorSurface({
    super.key,
  ...
  final DjedSittingBehaviorBuilder builder;

  @override
  State<DjedSittingBehaviorSurface> createState() =>
      _DjedSittingBehaviorSurfaceState();
}

class _DjedSittingBehaviorSurfaceState
    extends State<DjedSittingBehaviorSurface> {
  late String _move;
  ...
  @override
  void didUpdateWidget(covariant DjedSittingBehaviorSurface oldWidget) {
