...
kPilotMaatFlowResponseSpecs = <MaatFlowResponseSpec>[
  ...
  MaatFlowResponseSpec(
    id: kReadingHousePrivateReflectionSpecId,
    flowKey: kReadingHouseFlowKey,
    surface: MaatFlowResponseSurface.calendarSheet,
    kind: MaatFlowResponseKind.multiline,
    label: 'Private reflection',
    prompt: 'Begin with the private prompt. Writing is optional.',
    placeholder: 'What did this section ask you to hold?',
    journalPolicy: MaatFlowJournalPolicy.localOnly,
    journalBehavior: MaatFlowJournalBehavior.none,
    privacyClass: 'app_record_private',
  ),
  MaatFlowResponseSpec(
    id: kReadingHouseShortNoteSpecId,
    flowKey: kReadingHouseFlowKey,
    surface: MaatFlowResponseSurface.calendarSheet,
    kind: MaatFlowResponseKind.text,
    label: 'Short note',
    prompt: 'Save a small local marker for your own return.',
    placeholder: 'Page, phrase, question, or next place to return.',
    journalPolicy: MaatFlowJournalPolicy.localOnly,
    journalBehavior: MaatFlowJournalBehavior.none,
    privacyClass: 'app_record_private',
  ),
  MaatFlowResponseSpec(
    id: kReadingHouseSitWithoutWritingSpecId,
    flowKey: kReadingHouseFlowKey,
    surface: MaatFlowResponseSurface.calendarSheet,
    kind: MaatFlowResponseKind.checkbox,
    label: 'Sit without writing',
    placeholder: 'I sat with the reading without writing a reflection.',
    journalPolicy: MaatFlowJournalPolicy.localOnly,
    journalBehavior: MaatFlowJournalBehavior.none,
    privacyClass: 'app_record_private',
  ),
  MaatFlowResponseSpec(
    id: kReadingHousePositionSpecId,
    flowKey: kReadingHouseFlowKey,
    surface: MaatFlowResponseSurface.calendarSheet,
    kind: MaatFlowResponseKind.choice,
    label: 'Reading position',
    prompt: 'Choose one before marking the sitting.',
    options: <MaatFlowResponseOption>[
      MaatFlowResponseOption(
        id: kReadingHousePositionCarrying,
        label: 'Carrying',
      ),
      MaatFlowResponseOption(id: kReadingHousePositionNotYet, label: 'Not yet'),
    ],
    requiredForObserved: true,
    journalPolicy: MaatFlowJournalPolicy.localOnly,
    journalBehavior: MaatFlowJournalBehavior.none,
    privacyClass: 'app_record_private',
  ),
