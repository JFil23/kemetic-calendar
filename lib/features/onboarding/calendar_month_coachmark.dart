...
class CalendarMonthCoachmark extends StatefulWidget {
  const CalendarMonthCoachmark({
    super.key,
  ...
  @override
  State<CalendarMonthCoachmark> createState() => _CalendarMonthCoachmarkState();
}

class _CalendarMonthCoachmarkState extends State<CalendarMonthCoachmark>
  ...
  @override
  void didUpdateWidget(covariant CalendarMonthCoachmark oldWidget) {
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Tap the month for more information.',
                                      style: TextStyle(
