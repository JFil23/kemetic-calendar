...
class KemeticDayData {
  ...
  static final List<DecanDayInfo> renwetIFlowRows = [
    DecanDayInfo(
      ...
      action:
          'Acknowledge what has arrived — harvest, payment, relief, breakthrough — without denial or boasting.',
      reflection:
          '"What did I just receive that I refused to call sacred because I was too used to struggle?"',
    ),
    DecanDayInfo(
      day: 2,
      theme: 'Sort the Blessing',
      action:
          'Separate what is for you, what is for the house, what is for offering.',
      reflection: '"Can I tell the difference between mine and ours?"',
    ),
    DecanDayInfo(
      day: 3,
      theme: 'Offer First Share',
      action:
          'Return the first portion to Source: ancestors, gods, community need.',
      reflection:
          '"Did I honor where this came from before I kept any for myself?"',
    ),
    DecanDayInfo(
      day: 4,
      theme: 'Feed the House',
      action:
          'Make sure the people under your care are nourished in body and spirit.',
      reflection:
          '"Is anyone in my circle hungry, unseen, or running on empty?"',
    ),
    DecanDayInfo(
      day: 5,
      theme: 'Record the Gain Honestly',
      action: 'Write down what truly came in. No inflation, no hiding.',
      reflection:
          '"If I vanished tomorrow, could someone read the record and know I lived in Maʿat?"',
    ),
    DecanDayInfo(
      day: 6,
      theme: 'Pay the Hands',
      action:
          'Compensate labor. Cancel hidden debt. Acknowledge who carried you.',
      reflection:
          '"Have I thanked the ones who lifted with me, or am I acting like I did this alone?"',
    ),
    DecanDayInfo(
      day: 7,
      theme: 'Rest the Field',
      action: 'Do not strip the source bare. Leave breathing room for renewal.',
      reflection: '"Am I harvesting — or am I draining?"',
    ),
    DecanDayInfo(
      day: 8,
      theme: 'Speak Gratitude Aloud',
      action:
          'Say thank you where it can be heard — to the living, to the dead, to the divine.',
      reflection: '"Who needs to hear that I am grateful for them today?"',
    ),
    DecanDayInfo(
      day: 9,
      theme: 'Secure the Store',
      action:
          'Protect what remains with order: seal containers, plan rations, prevent spoilage and theft.',
      reflection:
          '"Can I keep this blessing safe without becoming paranoid or stingy?"',
    ),
    DecanDayInfo(
      day: 10,
      theme: 'Seal the Name',
      action:
          'Declare who you are now that you have received. Align fate (šai) with how you intend to carry this.',
      reflection:
          '"What does Renenutet know my name to mean — and am I living like that name is true?"',
    ),
  ];
  ...
  static final List<DecanDayInfo> renwetIIFlowRows = [
    DecanDayInfo(
      day: 11,
      theme: 'Stand in the Light',
      action: 'Let yourself be seen as you really are in this season.',
      reflection:
          '"If someone watched how I handled abundance, would they call me honorable?"',
    ),
    DecanDayInfo(
      day: 12,
      theme: 'Weigh the Heart',
      action: 'Compare intention vs behavior. Did you live what you preached?',
      reflection: '"Does my heart match my mouth?"',
    ),
    DecanDayInfo(
      day: 13,
      theme: 'Confess the Excess',
      action:
          'Name where you took too much, ignored need, or acted out of fear.',
      reflection: '"Where did I slip into greed, and why?"',
    ),
    DecanDayInfo(
      day: 14,
      theme: 'Correct the Imbalance',
      action:
          'Make a concrete repair: repay, apologize, redistribute, restore dignity.',
      reflection:
          '"Who deserves repair from me before this cycle can be called clean?"',
    ),
    DecanDayInfo(
      day: 15,
      theme: 'Protect the Innocent',
      action:
          'Shield the vulnerable with what you\'ve gained — children, elders, exhausted workers, yourself.',
      reflection: '"Who is still exposed, and why am I okay with that?"',
    ),
    DecanDayInfo(
      day: 16,
      theme: 'Speak the Record Publicly',
      action:
          'Say what happened this cycle in front of witnesses: what came in, what you did, what you\'ll fix.',
      reflection:
          '"Do the people around me know my truth, or just my performance?"',
    ),
    DecanDayInfo(
      day: 17,
      theme: 'Honor the Honest Worker',
      action:
          'Tell the stories of those who carried the season with integrity.',
      reflection: '"Whose name deserves to shine from this harvest?"',
    ),
    DecanDayInfo(
      day: 18,
      theme: 'Consecrate the Oath',
      action: 'State what code you will live by going forward.',
      reflection: '"What promise will I stake my name on?"',
    ),
    DecanDayInfo(
      day: 19,
      theme: 'Seal Reputation',
      action:
          'Accept that how you moved in this harvest is now part of your name.',
      reflection:
          '"If my child repeated what I did this season, would I feel pride or shame?"',
    ),
    DecanDayInfo(
      day: 20,
      theme: 'Rest in Witness',
      action:
          'Release anxiety. You faced truth. You corrected what you could. Be still in Maʿat.',
      reflection: '"Can I sit in quiet knowing I did not hide?"',
    ),
  ];
  ...
  static final List<DecanDayInfo> renwetIIIFlowRows = [
    DecanDayInfo(
      day: 21,
      theme: 'Store the Harvest',
      action: 'Secure what you gathered. Clean jars. Label. Seal.',
      reflection:
          '"Do I know what I actually have — or am I just assuming I\'m fine?"',
    ),
    DecanDayInfo(
      day: 22,
      theme: 'Thank the Source',
      action:
          'Offer first-share gratitude to what fed you: land, river, hands, ancestors, the Divine.',
      reflection:
          '"Have I returned gratitude in a way the Source would recognize as real?"',
    ),
    DecanDayInfo(
      day: 23,
      theme: 'Bless the Tools',
      action:
          'Clean, oil, and wrap what served you this cycle — body tools, money tools, craft tools.',
      reflection:
          '"Do I show respect to what carried the work, or do I only use and discard?"',
    ),
    DecanDayInfo(
      day: 24,
      theme: 'Close the Ledger',
      action:
          'Write the final account of this season. What came in, what went out, what remains.',
      reflection: '"Is there any number I\'m scared to face?"',
    ),
    DecanDayInfo(
      day: 25,
      theme: 'Name the Lessons',
      action:
          'State clearly what this cycle taught you — skill, warning, truth about yourself.',
      reflection: '"What will not be repeated? What must be repeated?"',
    ),
    DecanDayInfo(
      day: 26,
      theme: 'Give Quiet Blessing Forward',
      action:
          'Place intention on the next cycle without trying to control it. Speak life into what comes.',
      reflection:
          '"Can I bless what hasn\'t happened yet without grabbing for it?"',
    ),
    DecanDayInfo(
      day: 27,
      theme: 'Release the Burden',
      action:
          'Let go of the strain response. You are not in active crisis anymore.',
      reflection:
          '"Am I still clenching like I\'m in survival mode, even though I\'m not?"',
    ),
    DecanDayInfo(
      day: 28,
      theme: 'Return to Silence',
      action:
          'Practice sacred quiet. Reduce noise, opinion, performance. Let the nervous system settle.',
      reflection:
          '"When was the last time I let myself be silent in front of the Source and didn\'t fill the silence?"',
    ),
    DecanDayInfo(
      day: 29,
      theme: 'Lay Down the Body',
      action:
          'Honor rest as a holy act. Sleep early. Move gently. Stop proving.',
      reflection:
          '"Do I believe rest is allowed, or do I still treat it like theft?"',
    ),
    DecanDayInfo(
      day: 30,
      theme: 'Offer the Cycle Back to Time',
      action:
          'Accept completion. Nothing left to squeeze. Give the season back to Maʿat and step into peace.',
      reflection:
          '"Can I end without dragging guilt, hoarding fear, or clinging to control?"',
    ),
  ];
  ...
  static final List<DecanDayInfo> hnswIFlowRows = [
    DecanDayInfo(
      day: 1,
      theme: 'Step Onto the Path',
      action:
          'Declare today\'s path out loud. Move with stated purpose, not drift.',
      reflection: '"Where am I going — and why?"',
    ),
    DecanDayInfo(
      day: 2,
      theme: 'Carry the Light',
      action:
          'Let your presence uplift, not scorch. Travel with calm face, steady breath.',
      reflection: '"Does my heat nourish or dominate?"',
    ),
    DecanDayInfo(
      day: 3,
      theme: 'Honor the Heat',
      action:
          'Accept difficulty without complaint. Dress for it, plan for it, respect it.',
      reflection:
          '"Am I angry at conditions that are simply part of the season?"',
    ),
    DecanDayInfo(
      day: 4,
      theme: 'Travel Clean',
      action:
          'Check conduct while in motion — tone, honesty, promises, money exchanges.',
      reflection: '"Would Maʿat be ashamed to walk beside me today?"',
    ),
    DecanDayInfo(
      day: 5,
      theme: 'Move With Offering',
      action:
          'Bring something with you when you arrive (help, food, clarity, skill).',
      reflection: '"Do I enter spaces as a taker, or as a contributor?"',
    ),
    DecanDayInfo(
      day: 6,
      theme: 'Protect the Vessel',
      action:
          'Guard your body and mind while traveling. Hydrate, rest joints, shield spirit from nonsense.',
      reflection: '"Am I treating myself like cargo or like sacred transport?"',
    ),
    DecanDayInfo(
      day: 7,
      theme: 'Witness the Route',
      action:
          'Pay attention. Notice patterns, people, needs. The road itself is intelligence.',
      reflection: '"What is this path showing me about the world I serve?"',
    ),
    DecanDayInfo(
      day: 8,
      theme: 'Speak the Blessing',
      action:
          'Offer safe-travel words for others. "May you arrive in peace. May your load return multiplied."',
      reflection: '"Do I extend protection, or do I only ask for mine?"',
    ),
    DecanDayInfo(
      day: 9,
      theme: 'Record the Day\'s Distance',
      action:
          'Take simple account of what was done, earned, delivered, promised.',
      reflection:
          '"What actually happened on my path today — not the story, the facts?"',
    ),
    DecanDayInfo(
      day: 10,
      theme: 'Lay Down Without Arrogance',
      action:
          'Rest without boasting about how hard you worked. Sit in quiet, thank Ra for safe passage, close the day.',
      reflection:
          '"Can I end today without demanding applause for surviving it?"',
    ),
  ];
  ...
  static final List<DecanDayInfo> hnswIIFlowRows = [
    DecanDayInfo(
      day: 11,
      theme: 'Name the Terms',
      action: 'State clearly what you are doing, trading, agreeing to.',
      reflection:
          '"Have I said aloud what I am promising, or am I hiding vagueness inside the deal?"',
    ),
    DecanDayInfo(
      day: 12,
      theme: 'Travel With Witness',
      action:
          'Assume Maʿat is standing beside you. Conduct yourself like you\'re being recorded forever.',
      reflection: '"Would I repeat today\'s words in front of my ancestors?"',
    ),
    DecanDayInfo(
      day: 13,
      theme: 'Keep Measure',
      action:
          'Track energy, money, time, and voice. Don\'t overspend any of them for pride.',
      reflection:
          '"Where am I leaking resources just to feel powerful in the moment?"',
    ),
    DecanDayInfo(
      day: 14,
      theme: 'Speak Cleanly',
      action:
          'No frantic speech. No panicked promises. No lies to "smooth things over."',
      reflection: '"Did I warp truth today just to avoid discomfort?"',
    ),
    DecanDayInfo(
      day: 15,
      theme: 'Honor the Exchange',
      action:
          'Pay fair, demand fair. No exploiting desperation, and no offering yourself cheaply.',
      reflection:
          '"Did I cheapen myself, or did I try to cheapen someone else?"',
    ),
    DecanDayInfo(
      day: 16,
      theme: 'Travel Under Oath',
      action:
          'Treat your word as binding. If you say you will do it, you have placed seal on it.',
      reflection: '"Do I use language like a contract, or like smoke?"',
    ),
    DecanDayInfo(
      day: 17,
      theme: 'Protect the Quiet',
      action:
          'Schedule silence. You cannot think clearly if you never withdraw.',
      reflection: '"Where in this day did my mind get to breathe?"',
    ),
    DecanDayInfo(
      day: 18,
      theme: 'Check for Poison',
      action:
          'Scan for corruption in your circle — lies, envy, exploitation, manipulation disguised as love or help.',
      reflection: '"Who walks with me that is secretly against my balance?"',
    ),
    DecanDayInfo(
      day: 19,
      theme: 'Assert the Boundary',
      action:
          'Say "no" without apology. You are not obligated to carry what bends you out of Maʿat.',
      reflection: '"Where did I accept a load that is not mine?"',
    ),
    DecanDayInfo(
      day: 20,
      theme: 'Seal the Ledger',
      action:
          'Record agreements, payments, distances, loyalties. Make it written, not just remembered.',
      reflection:
          '"If I vanished tonight, would someone know what I built, what I owed, and what I am owed?"',
    ),
  ];
  ...
  static final List<DecanDayInfo> hnswIIIFlowRows = [
    DecanDayInfo(
      ...
      theme: 'Ease the Pace',
      action:
          'Consciously slow output. Shorten the workday. Move with deliberate steps.',
      reflection:
          '"Why am I still sprinting when the road has already been won?"',
    ),
    DecanDayInfo(
      day: 22,
      theme: 'Cool the Body',
      action:
          'Treat heat damage: rehydrate, bathe, stretch, oil the joints, restore breath.',
      reflection: '"Where is my body asking me to listen, not to push?"',
    ),
    DecanDayInfo(
      day: 23,
      theme: 'Redistribute the Load',
      action:
          'Shift weight. Ask for help. Hand off tasks. Share the burden so nothing (including you) cracks.',
      reflection:
          '"What am I carrying alone that was never meant to be carried alone?"',
    ),
    DecanDayInfo(
      day: 24,
      theme: 'Guard the Core',
      action:
          'Pull your energy back from distractions, leaks, and performative work.',
      reflection: '"Where do I spend effort just to be seen?"',
    ),
    DecanDayInfo(
      day: 25,
      theme: 'Honor Fatigue',
      action:
          'Fatigue is proof of offering, not weakness. Let the body rest without apology.',
      reflection: '"Can I let tiredness be holy?"',
    ),
    DecanDayInfo(
      day: 26,
      theme: 'Release the Excess',
      action:
          'Remove what you gathered on the road but do not need — resentment, clutter, stale obligations.',
      reflection: '"What will not travel with me into the next cycle?"',
    ),
    DecanDayInfo(
      day: 27,
      theme: 'Enter Stillness',
      action:
          'Shorten speech. Move quietly. Sit in evening light and allow the nervous system to drop.',
      reflection:
          '"Have I given my spirit true silence before I re-enter the world?"',
    ),
    DecanDayInfo(
      day: 28,
      theme: 'Give Thanks for Distance Traveled',
      action:
          'Record where you started and where you are. See the distance honestly and bless it.',
      reflection:
          '"If I met myself from the beginning of this path, what would I tell them I learned?"',
    ),
    DecanDayInfo(
      day: 29,
      theme: 'Return to Center / Come Home',
      action:
          'Re-ground in home, altar, lineage, promise. Make contact with the source you move for.',
      reflection: '"To whom — or to what law — do I ultimately belong?"',
    ),
    DecanDayInfo(
      day: 30,
      theme: 'Offer the Report to Ra',
      action:
          'Deliver your accounting: what you carried, how you behaved, what you upheld. Close the journey in Maʿat.',
      reflection:
          '"If Ra asked, \'How did you travel in my light?,\' what would I truthfully answer?"',
    ),
  ];
  ...
  static final List<DecanDayInfo> hentiHetIFlowRows = [
    DecanDayInfo(
      day: 1,
      theme: 'Rise Before the Heat',
      action:
          'Wake early. Begin sacred work in first light. Honor the sun by meeting it, not chasing it.',
      reflection:
          '"Did I greet the day as a keeper, or stumble into it as a beggar?"',
    ),
    DecanDayInfo(
      day: 2,
      theme: 'Work Clean, Work Brief',
      action:
          'Do essential labor only. No waste motion. Finish before the blaze.',
      reflection: '"How much of what I call \'work\' is actually noise?"',
    ),
    DecanDayInfo(
      day: 3,
      theme: 'Guard the Breath',
      action:
          'Regulate breathing. Slow the heart. Keep speech cool, especially when provoked.',
      reflection: '"Did my mouth pour fire or water?"',
    ),
    DecanDayInfo(
      day: 4,
      theme: 'Offer Back the Excess Heat',
      action:
          'Release anger, urgency, and greed as offerings — not suppressed, but surrendered to Ra.',
      reflection: '"What in me is running too hot for balance?"',
    ),
    DecanDayInfo(
      day: 5,
      theme: 'Honor Proportion',
      action: 'Take only what is needed today. Ration calmly. Do not grasp.',
      reflection: '"Am I consuming for need, or out of fear?"',
    ),
    DecanDayInfo(
      day: 6,
      theme: 'Shade the Vulnerable',
      action:
          'Protect children, elders, the tired, the overworked. Become shade for someone else.',
      reflection: '"Whose suffering did I cool today?"',
    ),
    DecanDayInfo(
      day: 7,
      theme: 'Keep the Record',
      action:
          'Write what was given and what was spent. Peace comes from accounted exchange.',
      reflection:
          '"Can I name what I owe, what I\'ve received, and what I returned?"',
    ),
    DecanDayInfo(
      day: 8,
      theme: 'Cool the Eye',
      action:
          'Lower the gaze. Refuse escalation. Practice gentleness where wrath is expected.',
      reflection: '"Did I calm the Eye, or did I feed it?"',
    ),
    DecanDayInfo(
      day: 9,
      theme: 'Speak Soft to the Body',
      action:
          'Oil, water, shade, rest. Treat the body like entrusted temple equipment, not disposable gear.',
      reflection: '"Did I keep the vessel worthy of the Ka?"',
    ),
    DecanDayInfo(
      day: 10,
      theme: 'Seal the Morning Oath',
      action:
          'Affirm aloud who you intend to be under heat. Set vow for the rest of the month.',
      reflection: '"When the sun tests me, what do I refuse to become?"',
    ),
  ];
  ...
  static final List<DecanDayInfo> hentiHetIIFlowRows = [
    DecanDayInfo(
      ...
      theme: 'Name the Fire',
      action:
          'Admit honestly what burns in you — anger, desire, urgency, hunger for control.',
      reflection: '"What is the true heat in me right now?"',
    ),
    DecanDayInfo(
      day: 12,
      theme: 'Purify the Intention',
      action:
          'Decide what that fire is for. Give it a purpose that serves Maʿat, not ego.',
      reflection: '"Does my will build life or just prove I\'m powerful?"',
    ),
    DecanDayInfo(
      day: 13,
      theme: 'Sweeten the Flame',
      action:
          'Perform a cooling act: incense, water on the forehead, soft words where you\'d usually strike.',
      reflection:
          '"How did I soften something today that could have scorched?"',
    ),
    DecanDayInfo(
      day: 14,
      theme: 'Repair Harm Done in Heat',
      action:
          'Apologize. Rebalance. Return what you took harshly. Restore what you broke.',
      reflection: '"Where did my heat injure someone who trusted me?"',
    ),
    DecanDayInfo(
      day: 15,
      theme: 'Speak Under Oath',
      action:
          'Speak only what you are willing to stand beside in the Hall of Maʿat.',
      reflection: '"Would I repeat these words in front of the scales?"',
    ),
    DecanDayInfo(
      day: 16,
      theme: 'Burn Away the Rot',
      action:
          'Release habits, cravings, alliances, or objects that rot the spirit. Let fire consume what should end.',
      reflection: '"What must not cross into the next season with me?"',
    ),
    DecanDayInfo(
      day: 17,
      theme: 'Consecrate the Body',
      action:
          'Oil, cleanse, adorn. Present yourself as sacred vessel, not exhausted tool.',
      reflection: '"Do I carry myself like temple equipment, or like scrap?"',
    ),
    DecanDayInfo(
      day: 18,
      theme: 'Offer Heat as Service',
      action:
          'Use your strength where it actually matters — defense of the weak, hard labor no one else will do.',
      reflection: '"Who received my strength today besides me?"',
    ),
    DecanDayInfo(
      day: 19,
      theme: 'Hold Still in the Blaze',
      action:
          'Practice composure under provocation. Do not flinch, do not erupt.',
      reflection: '"When I was tested, did I hold form?"',
    ),
    DecanDayInfo(
      day: 20,
      theme: 'Seal the Flame in Devotion',
      action: 'State aloud what your fire now serves. Bind it.',
  ...
  static final List<DecanDayInfo> hentiHetIIIFlowRows = [
    DecanDayInfo(
      day: 21,
      theme: 'Stand Down the Body',
      action:
          'Release tension. Allow muscles to unlock. Acknowledge fatigue without shame.',
      reflection: '"Where am I still pretending I\'m not tired?"',
    ),
    DecanDayInfo(
      day: 22,
      theme: 'Secure the Storehouse',
      action:
          'Check what you\'ve gathered — food, money, agreements, tools. Protect it with care and thanks.',
      reflection: '"Have I honored what I asked the world to give me?"',
    ),
    DecanDayInfo(
      day: 23,
      theme: 'Sharpen and Mend',
      action:
          'Clean blades, repair handles, sweep workspaces. Restore your instruments to readiness.',
      reflection: '"Will Future Me inherit tools in dignity, or in chaos?"',
    ),
    DecanDayInfo(
      day: 24,
      theme: 'Release the Burden',
      action:
          'Lay down tasks that are no longer yours to carry. Stop hauling out of pride.',
      reflection:
          '"What weight am I carrying just so no one thinks I\'m weak?"',
    ),
    DecanDayInfo(
      day: 25,
      theme: 'Honor the Body as Survivor',
      action:
          'Tend bruises, burns, soreness. Oil joints. Feed and water yourself with patience.',
      reflection: '"Do I treat my own body like a worker I value?"',
    ),
    DecanDayInfo(
      day: 26,
      theme: 'Speak Gratitude to the Source',
      action:
          'Offer thanks aloud — to Ra, to the river, to the ancestors, to the people who labored with you.',
      reflection: '"Did I act like I did this alone?"',
    ),
    DecanDayInfo(
      day: 27,
      theme: 'Record the Season',
      action:
          'Write what was gained, lost, learned. Fix this cycle in memory so Maʿat can witness it.',
      reflection:
          '"If I vanished, would the record show that I served balance?"',
    ),
    DecanDayInfo(
      day: 28,
      theme: 'Establish Boundary for Rest',
      action:
          'Declare that rest is not laziness. State that no one may demand more of you than Maʿat allows.',
      reflection: '"Have I granted myself lawful rest?"',
    ),
    DecanDayInfo(
      day: 29,
      theme: 'Return Excess',
      action:
          'Give back overflow — food, money, attention, teaching — so that no blessing rots in hoarding.',
      reflection: '"What am I keeping that should be circulating?"',
    ),
    DecanDayInfo(
      day: 30,
      theme: 'Seal the Offering',
      action:
          'Close the month with an intentional offering (object, action, vow) that says: "It was enough."',
      reflection: '"Have I ended this cycle in gratitude, not in hunger?"',
    ),
  ];
  ...
  static final List<DecanDayInfo> iptHmtIFlowRows = [
    DecanDayInfo(
      day: 1,
      theme: 'Call the Lineage',
      action:
          'Speak the names of your people out loud, living and passed. Invite them to stand with you.',
      reflection: '"Whose strength is still moving in me?"',
    ),
    DecanDayInfo(
      day: 2,
      theme: 'Clean the Shrine / Clean the Room',
      action:
          'Wipe, sweep, clear dust from any place of memory (altar, photos, grave, heirloom).',
      reflection: '"Do I keep my ancestors in neglect or in honor?"',
    ),
    DecanDayInfo(
      day: 3,
      theme: 'Offer Sustenance',
      action:
          'Place water, bread, fruit, incense, song, or breath as an offering to the Ka that sustains you.',
      reflection: '"Have I thanked the force that is quietly feeding me?"',
    ),
    DecanDayInfo(
      day: 4,
      theme: 'Listen for Instruction',
      action:
          'Sit in stillness and ask for guidance from those who endured before you.',
      reflection: '"What are they telling me to correct while I still can?"',
    ),
    DecanDayInfo(
      day: 5,
      theme: 'Repair the Story',
      action:
          'Tell the truth about what happened in your line — including the pain — without shame.',
      reflection: '"Which silence in my family is killing us?"',
    ),
    DecanDayInfo(
      day: 6,
      theme: 'Carry Forward a Virtue',
      action:
          'Choose one trait from an ancestor (craft, discipline, tenderness, defiance) and practice it.',
      reflection: '"What gift of theirs will I keep alive today on purpose?"',
    ),
    DecanDayInfo(
      day: 7,
      theme: 'Reaffirm Your Place',
      action:
          'Say plainly: "I am not alone. I am carried." Declare yourself part of an unbroken chain.',
      reflection: '"Do I live like an isolated self or as a continuation?"',
    ),
    DecanDayInfo(
      day: 8,
      theme: 'Bind the Household',
      action:
          'Share blessing with the living: protect children, comfort elders, resolve tension at home.',
      reflection:
          '"Did I extend the protection I pray for, or did I hoard it?"',
    ),
    DecanDayInfo(
      day: 9,
      theme: 'Promise Continuity',
      action:
          'Write or speak one thing you will pass on — knowledge, ritual, land, ethic, defense.',
      reflection: '"If I fall tomorrow, what survives because of me?"',
    ),
    DecanDayInfo(
      day: 10,
      theme: 'Seal the Lineage Vow',
      action:
          'Mark this cycle with a vow to honor and maintain your line in Maʿat going forward.',
      reflection:
          '"Will my name be spoken with pride when I cross into the West?"',
    ),
  ];
  ...
  static final List<DecanDayInfo> iptHmtIIFlowRows = [
    DecanDayInfo(
      day: 11,
      theme: 'Stand Before Your Name',
      action: 'Look at your own life plainly. No excuses.',
      reflection: '"If I died today, would they call me true of voice?"',
    ),
    DecanDayInfo(
      day: 12,
      theme: 'Pour the Water',
      action: 'Make a quiet offering to those who walked in Maʿat before you.',
      reflection:
          '"Who in my line actually lived right, and what did that look like in practice?"',
    ),
    DecanDayInfo(
      day: 13,
      theme: 'Measure Your Conduct',
      action: 'Compare how you move with how you say you move. Close that gap.',
      reflection: '"Where am I pretending to be aligned but I am not?"',
    ),
    DecanDayInfo(
      day: 14,
      theme: 'Correct Harm You Caused',
      action:
          'Repair something you damaged — relationship, trust, agreement, boundary, resource.',
      reflection: '"Who deserves repair from me?"',
    ),
    DecanDayInfo(
      day: 15,
      theme: 'Clean Your Name',
      action:
          'Remove filth from around your name — gossip, needless drama, falsehood, self-sabotage you keep feeding.',
      reflection: '"What stain around my name is my own doing?"',
    ),
    DecanDayInfo(
      day: 16,
      theme: 'Speak Your Standard Aloud',
      action: 'State clearly what is and is not acceptable for you anymore.',
      reflection: '"What line in the sand must I draw for myself?"',
    ),
    DecanDayInfo(
      day: 17,
      theme: 'Protect Your Word',
      action:
          'Do not say what you will not keep. Do not promise what you cannot carry.',
      reflection: '"Where am I cheap with my word?"',
    ),
    DecanDayInfo(
      day: 18,
      theme: 'Hold Your Center in Heat',
      action:
          'Stay aligned under pressure. Anger, temptation, insult — do not betray yourself.',
      reflection: '"Do I only live Maʿat when it\'s easy?"',
    ),
    DecanDayInfo(
      day: 19,
      theme: 'Honor the Quiet Ones',
      action:
          'Give thanks to the ancestor whose greatness wasn\'t loud — the consistent, the humble, the overlooked.',
      reflection: '"Whose quiet strength have we failed to praise?"',
    ),
    DecanDayInfo(
      day: 20,
      theme: 'Prepare to Be Remembered',
      action:
          'Decide what memory of you should survive. Start living so it will be true.',
      reflection:
          '"What sentence will my people speak about me when I am gone — and will it be honest?"',
    ),
  ];
  ...
  static final List<DecanDayInfo> iptHmtIIIFlowRows = [
    DecanDayInfo(
      day: 21,
      theme: 'Claim the Line',
      action:
          'Accept that you are in the lineage — you are not separate from it.',
      reflection: '"Whose work am I continuing with my life?"',
    ),
    DecanDayInfo(
      day: 22,
      theme: 'Receive the Charge',
      action: 'Identify the specific duty that has fallen to you to carry.',
      reflection: '"What responsibility is now mine because others are gone?"',
    ),
    DecanDayInfo(
      day: 23,
      theme: 'Name the Scar',
      action:
          'Acknowledge the wound, failure, or break in the line you are inheriting.',
      reflection:
          '"What damage am I inheriting that I refuse to pass forward?"',
    ),
    DecanDayInfo(
      day: 24,
      theme: 'Swear Continuity',
      action:
          'Make a vow to preserve what must endure: protection, dignity, resource, story, sanctuary.',
      reflection: '"What will not be allowed to die with me?"',
    ),
    DecanDayInfo(
      day: 25,
      theme: 'Refuse the Rot',
      action:
          'Name what ends with you — violence, shame, silence, addiction, cowardice, hunger, abandonment.',
      reflection: '"What poison stops in my generation?"',
    ),
    DecanDayInfo(
      day: 26,
      theme: 'Build the Bridge',
      action:
          'Create or repair one structure that lets the next ones stand taller: money set aside, knowledge recorded.',
      reflection:
          '"What tool or record can I create so they do not have to start over from zero?"',
    ),
    DecanDayInfo(
      day: 27,
      theme: 'Transfer the Teachings',
      action: 'Teach something forward — skill, law, prayer, map.',
      reflection: '"Who needs to know what I know while I am still breathing?"',
    ),
    DecanDayInfo(
      day: 28,
      theme: 'Pledge Publicly',
      action:
          'Announce (out loud, in writing, in ritual) what you are carrying and for whom.',
      reflection: '"Who will I say I stand for?"',
    ),
    DecanDayInfo(
      day: 29,
      theme: 'Seal the House',
      action:
          'Put your affairs in order before the year turns: physical, spiritual, financial, relational.',
      reflection: '"If I vanish tonight, is the path after me clear or chaos?"',
    ),
    DecanDayInfo(
      day: 30,
      theme: 'Stand Before the Dawn',
      action:
          'Present yourself to the threshold of the new year as Horus does: upright, accountable, unhidden.',
      reflection:
          '"Am I ready to stand on Sah — to inherit Maʿat without apology?"',
    ),
  ];
  ...
  static final List<DecanDayInfo> mswtRaIFlowRows = [
    DecanDayInfo(
      day: 1,
      theme: 'Surrender to Stillness',
      action: 'Stop forcing motion. Stop scrambling. Be still on purpose.',
      reflection:
          '"Where am I pretending I\'m \'fine\' just to avoid stopping?"',
    ),
    DecanDayInfo(
      day: 2,
      theme: 'Lay Down Weapons',
      action:
          'Release defenses you don\'t need anymore — the argument, the posture, the mask.',
      reflection: '"What am I gripping that is actually wounding me?"',
    ),
    DecanDayInfo(
      day: 3,
      theme: 'Loosen the Jaw / Breathe',
      action:
          'Unclench the jaw, drop the shoulders, lengthen the exhale. Invite breath like sacred water.',
      reflection: '"What would my breath sound like if I was safe?"',
    ),
    DecanDayInfo(
      day: 4,
      theme: 'Return to Body',
      action:
          'Place hands on chest, belly, throat. Feel where you are tense, numb, or missing. Name each place without judgment.',
      reflection: '"Where have I stopped living inside myself?"',
    ),
    DecanDayInfo(
      day: 5,
      theme: 'Offer the Remains',
      action:
          'Gather what\'s left of you — even if it\'s pieces — and place it before Maʿat honestly.',
      reflection:
          '"If I lay myself on the altar as I am, what do I place there?"',
    ),
    DecanDayInfo(
      day: 6,
      theme: 'Receive Reassembly',
      action:
          'Let yourself be put back together. Accept help. Accept rest. Accept being held.',
      reflection:
          '"Where do I still refuse to be helped because I think I must deserve pain?"',
    ),
    DecanDayInfo(
      day: 7,
      theme: 'Raise the Djed',
      action:
          'Feel the spine as Djed — the backbone of Asar (Osiris) re-stood. Sit upright in quiet strength, not performance.',
      reflection: '"Can I sit in my own stability without needing applause?"',
    ),
    DecanDayInfo(
      day: 8,
      theme: 'Accept the Naming',
      action:
          'Speak your true name, not the insult or the label thrown on you. Claim the name that aligns with Maʿat.',
      reflection:
          '"What am I really called in this world, beneath survival titles?"',
    ),
    DecanDayInfo(
      day: 9,
      theme: 'Keep Silent Watch',
      action:
          'Observe without reacting. Become witness. Hold the border of your life like a temple guard at night.',
      reflection:
          '"What crosses my boundary that does not belong in the next cycle?"',
    ),
    DecanDayInfo(
      day: 10,
      theme: 'Hold the Gate',
      action:
          'Stand at the threshold of rebirth with discipline and tenderness. No panic. No begging. Only readiness.',
      reflection:
          '"Can I wait with dignity for what is mine, instead of chasing?"',
    ),
  ];
  ...
  static final List<DecanDayInfo> mswtRaIIFlowRows = [
    DecanDayInfo(
      day: 11,
      theme: 'Enter the Hidden',
      action: 'Step back from noise, withdraw from excess, honor stillness.',
      reflection: '"What part of me must go quiet to be reborn?"',
    ),
    DecanDayInfo(
      day: 12,
      theme: 'Release the Light',
      action:
          'Let go of something visible — habit, tension, clutter, identity crust.',
      reflection: '"What brightness has become burden?"',
    ),
    DecanDayInfo(
      day: 13,
      theme: 'Sink into Trust',
      action: 'Accept the unseen process working beneath visibility.',
      reflection: '"Can I trust what I cannot measure?"',
    ),
    DecanDayInfo(
      day: 14,
      theme: 'Prepare the Vessel',
      action: 'Clean body, space, tools — the womb must be ready.',
      reflection: '"What container must be purified for what is coming?"',
    ),
    DecanDayInfo(
      day: 15,
      theme: 'Seal the Silence',
      action: 'Commit to a quiet inner chamber — no gossip, no leaks.',
      reflection: '"Where is my silence being stolen?"',
    ),
    DecanDayInfo(
      day: 16,
      theme: 'Hold the Unborn',
      action: 'Sit in expectancy without forcing clarity.',
      reflection: '"Can I hold potential without demanding answers?"',
    ),
    DecanDayInfo(
      day: 17,
      theme: 'Warm the Inner Flame',
      action: 'Tend breath, posture, intention — build gentle power.',
      reflection: '"What inner spark needs gentle tending?"',
    ),
    DecanDayInfo(
      day: 18,
      theme: 'Call the Ancestors',
      action: 'Speak their names, recall their endurance.',
      reflection: '"Who walked before me while unseen?"',
    ),
    DecanDayInfo(
      day: 19,
      theme: 'Discern the Signs',
      action: 'Notice omens, patterns, alignments emerging from the quiet.',
      reflection: '"What is revealing itself subtly?"',
    ),
    DecanDayInfo(
      day: 20,
      theme: 'Stand at the Threshold',
      action: 'Prepare for the epagomenal days — the births of the gods.',
      reflection: '"What must I carry across the border of the year?"',
    ),
  ];
  ...
  static final List<DecanDayInfo> mswtRaIIIFlowRows = [
    DecanDayInfo(
      day: 21,
      theme: 'The First Fracture',
      action:
          'Acknowledge what has broken this year — without shame or denial.',
      reflection: '"What cracked for a reason?"',
    ),
    DecanDayInfo(
      day: 22,
      theme: 'Name the Pieces',
      action:
          'Identify the parts of self, life, or purpose scattered across months.',
      reflection: '"What lies where it fell?"',
    ),
    DecanDayInfo(
      day: 23,
      theme: 'Call the Pieces Back',
      action: 'Invite what was lost to return — strength, clarity, boundaries.',
      reflection: '"What wants to return to me?"',
    ),
    DecanDayInfo(
      day: 24,
      theme: 'Rebind the Limbs',
      action:
          'Begin reuniting what belongs together — habits, goals, identity.',
      reflection: '"What naturally goes with what?"',
    ),
    DecanDayInfo(
      day: 25,
      theme: 'Excise the False',
      action: 'Remove what does not belong to your restored self.',
      reflection: '"What was never truly mine?"',
    ),
    DecanDayInfo(
      day: 26,
      theme: 'Anoint the Wounds',
      action: 'Tend the vulnerable parts of your psyche, body, or home.',
      reflection: '"What wounds require oil, not armor?"',
    ),
    DecanDayInfo(
      day: 27,
      theme: 'Strengthen the Forming',
      action: 'Reinforce what is returning — stability, order, ritual.',
      reflection: '"What must be strengthened now, before rebirth?"',
    ),
    DecanDayInfo(
      day: 28,
      theme: 'Seal the New Shape',
      action: 'Commit to the form you will carry into the new year.',
      reflection: '"What shape am I choosing?"',
    ),
    DecanDayInfo(
      day: 29,
      theme: 'Stand as Osiris',
      action:
          'Claim the restored throne of your life — quiet, sovereign, whole.',
      reflection: '"What authority returns to me through wholeness?"',
    ),
    DecanDayInfo(
      day: 30,
      theme: 'Prepare for Birth',
      action:
          'Final purification before the Heriu Renpet. Everything is aligned.',
      reflection: '"What must be cleansed to welcome the gods?"',
    ),
  ];
  ...
  static final List<DecanDayInfo> epagomenalIFlowRows = [
    DecanDayInfo(
      day: 1,
      theme: 'Awakening',
      action: 'Water what is dormant — body, mind, plan, altar.',
      reflection: '"What in me is ready to sprout again?"',
    ),
    DecanDayInfo(
      day: 2,
      theme: 'Sight Restored',
      action: 'Clarify vision; clean lenses, screens, intentions.',
      reflection: '"What must I see without distortion?"',
    ),
    DecanDayInfo(
      day: 3,
      theme: 'Fire Balanced',
      action: 'Destroy one thing causing disorder or stagnation.',
      reflection: '"What chaos must I place back into its orbit?"',
    ),
    DecanDayInfo(
      day: 4,
      theme: 'Name Remembered',
      action: 'Speak truth aloud; declare your identity and aim.',
      reflection: '"What truth restores my power?"',
    ),
    DecanDayInfo(
      day: 5,
      theme: 'Threshold Kept',
      action: 'Honor ancestors, endings, and the unseen.',
      reflection: '"What must be remembered so nothing is lost?"',
    ),
  ];
  ...
  static final List<DecanDayInfo> rekhnedjesIFlowRows = [
    DecanDayInfo(
      day: 1,
      theme: 'Ground the Apprentice',
      action:
          'Acknowledge you are in training; set one clear focus for these 10 days.',
      reflection: '"Where in my life am I willing to be a student again?"',
    ),
    DecanDayInfo(
      day: 2,
      theme: 'Stand Under the Stars',
      action:
          'Rise early or step outside at night; look for Orion or imagine him.',
      reflection: '"What does my \'spine\' look like when no one is watching?"',
    ),
    DecanDayInfo(
      day: 3,
      theme: 'Quiet Repetition',
      action: 'Choose one simple skill and repeat it with care, not speed.',
      reflection: '"Can I love the practice, not just the result?"',
    ),
    DecanDayInfo(
      day: 4,
      theme: 'Straighten the Line',
      action:
          'Correct one crooked thing — a habit, schedule, boundary, or object.',
      reflection: '"Where has my line bent away from Maʿat?"',
    ),
    DecanDayInfo(
      day: 5,
      theme: 'Carry the Weight Well',
      action:
          'Do one physically or mentally demanding task with steady pacing.',
      reflection: '"Do I collapse under weight or learn how to carry it?"',
    ),
    DecanDayInfo(
      day: 6,
      theme: 'Listen While Working',
      action:
          'Work in silence or with sacred sound; let insight arise while in motion.',
      reflection: '"What does endurance teach me that comfort never could?"',
    ),
    DecanDayInfo(
      day: 7,
      theme: 'Heat of Trial',
      action:
          'Notice when irritation rises; do not speak until breath has cooled it.',
      reflection: '"What story do I tell myself when things get hard?"',
    ),
    DecanDayInfo(
      day: 8,
      theme: 'Silent Mastery',
      action: 'Complete a task excellently without announcing it to anyone.',
      reflection: '"Can I let the work speak louder than my mouth?"',
    ),
    DecanDayInfo(
      day: 9,
      theme: 'Hold the Standard',
      action: 'Review your progress; tighten anything that has grown sloppy.',
      reflection: '"What minimum level of order will I refuse to fall below?"',
    ),
    DecanDayInfo(
      day: 10,
      theme: 'Seal the Lesson',
      action:
          'Record what these 10 days taught you; make one vow for the next decan.',
      reflection: '"What endurance skill am I formally carrying forward?"',
    ),
  ];
  ...
  static final List<DecanDayInfo> rekhnedjesIIFlowRows = [
    DecanDayInfo(
      day: 11,
      theme: 'Seek the Elders',
      action:
          'Identify one living or ancestral "teacher" whose example you respect.',
      reflection: '"Whose pattern of life would I be honored to resemble?"',
    ),
    DecanDayInfo(
      day: 12,
      theme: 'Ask for Counsel',
      action:
          'Bring one real question about your path to that source of wisdom.',
      reflection: '"Where am I willing to be corrected?"',
    ),
    DecanDayInfo(
      day: 13,
      theme: 'Receive the Mirror',
      action: 'Listen to feedback without defending yourself.',
      reflection: '"What truth about me keeps repeating in different mouths?"',
    ),
    DecanDayInfo(
      day: 14,
      theme: 'Apprentice in Action',
      action: 'Apply one piece of counsel immediately in a concrete way.',
      reflection: '"How does obedience feel in my body?"',
    ),
    DecanDayInfo(
      day: 15,
      theme: 'Refine the Craft',
      action:
          'Practice your main skill under a higher standard set by your teachers.',
      reflection:
          '"What small adjustment makes my work more honest and precise?"',
    ),
    DecanDayInfo(
      day: 16,
      theme: 'Teach What You Know',
      action:
          'Share one lesson you\'ve embodied with someone younger or earlier on.',
      reflection: '"What do I now carry that is worth passing on?"',
    ),
    DecanDayInfo(
      day: 17,
      theme: 'Tend the Lineage',
      action:
          'Honor your line of influence — mentors, ancestors, unseen helpers.',
      reflection: '"Who kept the light for me before I arrived?"',
    ),
    DecanDayInfo(
      day: 18,
      theme: 'Discern the Voices',
      action: 'Separate wise guidance from noise, fear, or flattery.',
      reflection:
          '"Which voices leave me clearer, not more confused or inflated?"',
    ),
    DecanDayInfo(
      day: 19,
      theme: 'Choose Your Council',
      action:
          'Consciously select the few people/teachings that will shape your next year.',
      reflection: '"Who has earned the right to advise my life?"',
    ),
    DecanDayInfo(
      day: 20,
      theme: 'Seal the Teaching',
      action:
          'Record the guidance you\'re keeping and the actions it requires.',
      reflection:
          '"What teachings will I treat as law for myself going forward?"',
    ),
  ];
  ...
  static final List<DecanDayInfo> rekhnedjesIIIFlowRows = [
    DecanDayInfo(
      day: 21,
      theme: 'Release the Strain',
      action:
          'Acknowledge where you are clenched — body, schedule, or mind — and soften it.',
      reflection: '"What am I gripping that Maʿat is asking me to loosen?"',
    ),
    DecanDayInfo(
      day: 22,
      theme: 'Repair the Breaks',
      action:
          'Fix one small but real crack in your world (canal, budget, boundary).',
      reflection:
          '"What fracture, once mended, would let life flow more easily?"',
    ),
    DecanDayInfo(
      day: 23,
      theme: 'Clean the Tools',
      action: 'Wash, sharpen, or organize the instruments of your work.',
      reflection: '"Are my tools treated as sacred or as afterthoughts?"',
    ),
    DecanDayInfo(
      day: 24,
      theme: 'Reconcile Within',
      action: 'Bring two parts of yourself back into honest agreement.',
      reflection: '"Where am I telling myself two different stories?"',
    ),
    DecanDayInfo(
      day: 25,
      theme: 'Reconcile With Others',
      action: 'Take one step toward peace with someone where tension lingers.',
      reflection:
          '"What would it cost my ego — and save my spirit — to make amends?"',
    ),
    DecanDayInfo(
      day: 26,
      theme: 'Stabilize the Rhythm',
      action: 'Set a sustainable pattern for sleep, work, food, and movement.',
      reflection: '"Does my current rhythm support peace or sabotage it?"',
    ),
    DecanDayInfo(
      day: 27,
      theme: 'Honor Quiet Victories',
      action: 'Name and bless the small ways you\'ve endured and improved.',
      reflection: '"What quiet strengths do I usually refuse to acknowledge?"',
    ),
    DecanDayInfo(
      day: 28,
      theme: 'Simplify the Load',
      action:
          'Release one obligation, item, or habit that no longer serves Maʿat.',
      reflection: '"What weight can I lay down without betraying my purpose?"',
    ),
    DecanDayInfo(
      day: 29,
      theme: 'Prepare for the Crossing',
      action: 'Organize records, spaces, and plans for the coming month.',
      reflection:
          '"If the year turned tonight, what would I want already in order?"',
    ),
    DecanDayInfo(
      day: 30,
      theme: 'Rest in Maʿat',
      action: 'Practice deliberate rest as sacred duty, not laziness.',
      reflection:
          '"Can I trust that the world will not fall if I stop pushing?"',
    ),
  ];
...
To speak truth now is to write the law of your year.''',
      decanFlow: [
        DecanDayInfo(
          ...
          action:
              'Speak your intention for the year clearly — out loud or written.',
        ...
        DecanDayInfo(
          ...
          action:
              'Give something symbolic to the world (art, gratitude, time, service).',
        ...
        DecanDayInfo(
          ...
          theme: 'Purification',
          action:
              'Fast, bathe, or enter intentional silence to reset signal vs noise.',
...
Describe what balance looks and feels like when lived.''',
      ...
      meduNeter: MeduNeterKey(
        ...
        mantra:
            '"I see through Ma\'at\'s measure."', // ignore: unnecessary_string_escapes
      ),
    ),
...
''',
      decanFlow: [
        ...
        DecanDayInfo(
          day: 15,
          theme: 'Balance Check',
          action: 'Rest or partial fast; measure output vs cost.',
          reflection: '"Where am I overspending energy?"',
        ),
        DecanDayInfo(
          day: 16,
          theme: 'Reconnection',
          action: 'Reach out / reconnect with someone aligned to your purpose.',
        ...
        DecanDayInfo(
          ...
          theme: 'Transition',
          action:
              'Prepare for the next decan. Archive what matters, release what doesn\'t.',
      ...
      meduNeter: MeduNeterKey(
        ...
        colorFrequency:
            'Deep gold / warm copper — energy in motion, not hoarded',
        mantra: '"My offering sustains the balance."',
      ),
    ),
...
''',
      ...
      meduNeter: MeduNeterKey(
        ...
        colorFrequency:
            'Copper sealed with dark umber — flow closed, bond kept',
...
''',
      decanFlow: [
        ...
        DecanDayInfo(
          ...
          action: 'Draw one boundary that protects your work / energy.',
        ...
        DecanDayInfo(
          ...
          reflection: '"Who/what pulls me off my path?"',
        ),
        DecanDayInfo(
          day: 25,
        ...
        DecanDayInfo(
          ...
          action:
              'Connect your purpose to ancestry / legacy / historical current.',
        ...
        DecanDayInfo(
          ...
          action:
              'Present yourself in alignment (appearance, language, posture, bio, portfolio, feed).',
        ...
        DecanDayInfo(
          ...
          action:
              'Write or record your code: how you operate, what you do / don\'t do.',
        ...
        DecanDayInfo(
          ...
          action:
              'Put protection in place (legal, financial, emotional, time-guarding).',
        ...
        DecanDayInfo(
          ...
          action:
              'Close the month of Thoth: archive lessons, name this month\'s core truth.',
...
''',
      decanFlow: [
        ...
        DecanDayInfo(
          ...
          action:
              'Re-sync with your people / crew / household so you\'re not dragging alone.',
        ...
        DecanDayInfo(
          ...
          reflection:
              '"Can I continue this rhythm for 10 days without collapse?"',
        ),
        DecanDayInfo(
          day: 4,
          theme: 'Carry With Grace',
          action:
              'Treat the work as sacred process, not humiliation or desperation.',
          reflection: '"Do I see my labor as honor or insult?"',
        ),
        DecanDayInfo(
          day: 5,
          theme: 'Shared Provisioning',
          action: 'Shift weight, redistribute load, ask for help, give help.',
        ...
        DecanDayInfo(
          ...
          action:
              'Audit the cargo: am I hauling what serves my path, or am I hauling someone else\'s chaos?',
        ...
        DecanDayInfo(
          ...
          action:
              'Speak in alignment with the work you do. Announce yourself like you\'re part of a sacred procession.',
...
''',
      ...
      meduNeter: MeduNeterKey(
        ...
        colorFrequency:
            'Deep river blue in even bands — the Nile\'s steady pull',
...
''',
      ...
      meduNeter: MeduNeterKey(
        ...
        colorFrequency:
            'Copper, wet clay, deep river blue — living cooperation',
...
''',
      decanFlow: [
        DecanDayInfo(
          ...
          action:
              'Identify every place / person / pocket of your world that needs touch, presence, or supply from you.',
          reflection:
              '"Who depends on me staying connected, not disappearing?"',
        ),
        DecanDayInfo(
          day: 12,
          theme: 'Send the Carry Forward',
          action:
              'Deliver something outward: a resource, message, payment, repair, comfort, protection — even if it\'s small.',
          reflection:
              '"What can I send that proves \'you are not abandoned\'?"',
        ),
        DecanDayInfo(
          day: 13,
          theme: 'Establish Channels',
          action:
              'Formalize the lane: schedule, route, contact rhythm, standing check-in.',
        ...
        DecanDayInfo(
          ...
          action:
              'Acknowledge work happening away from you. Name and respect what others are carrying where you can\'t see them.',
          reflection:
              '"Who is holding it down in silence, and have I honored them?"',
        ),
        DecanDayInfo(
          day: 16,
        ...
        DecanDayInfo(
          ...
          action:
              'Speak peace, structure, clarity across distance. Set emotional tone in the spaces you touch.',
          reflection:
              '"What tone am I sending into rooms I\'m not physically in?"',
        ),
        DecanDayInfo(
          day: 18,
          theme: 'Tend the Network Health',
          action:
              'Check for resentment, isolation, miscommunication, resource starving. Repair tension fast.',
      ...
      meduNeter: MeduNeterKey(
        ...
        colorFrequency:
            'Ember orange over Nile blue — sparks across the current',
...
carry yourself like you answer to light, not to ego.''',
      decanFlow: [
        DecanDayInfo(
          ...
          reflection:
              '"What territory / people / system am I responsible for protecting right now?"',
        ),
        DecanDayInfo(
          day: 22,
          theme: 'Inspect the Channels',
          action:
              'Check for leaks, blockages, weak banks, damage, theft, decay in the routes (money flow, emotional flow, resource flow).',
        ...
        DecanDayInfo(
          ...
          action:
              'Count what\'s actually there vs what was promised. No fantasy math.',
        ...
        DecanDayInfo(
          ...
          theme: 'Call Out Rot',
          action:
              'Name corruption / laziness / sabotage / lies — calmly, factually.',
          reflection:
        ...
        DecanDayInfo(
          ...
          action:
              'Make it explicit: who is doing what, for whom, by when, with what support.',
        ...
        DecanDayInfo(
          ...
          action:
              'Acknowledge openly (to yourself, to your people, to Source) what is true — progress and failures.',
        ...
        DecanDayInfo(
          ...
          action:
              'Patch, repair, redistribute, lock things down so they hold through the next month.',
          reflection:
              '"What needs to be fixed today so it won\'t break tomorrow?"',
        ),
        DecanDayInfo(
          day: 30,
...
You are allowed to say "This is corruption," and still be in Ma'at.''',
      ...
      meduNeter: MeduNeterKey(
        ...
        colorFrequency:
            'Bright gold against dark rot — light exposing infection',
...
That is not cruelty. That is protection of Ma'at.''',
      ...
      meduNeter: MeduNeterKey(
        ...
        colorFrequency:
            'Bright line of gold cutting across deep blue — the boundary re-drawn so water doesn\'t swallow the village',
...
In you: repair, redistribute, finalize, set guards, put systems in place so things don't fall apart the second you look away.''',
      ...
      meduNeter: MeduNeterKey(
        ...
        colorFrequency:
            'Clay red and steady gold — repaired walls holding firm',
...
You hand the month back clean.''',
    ...
    'hathor_1_1': KemeticDayInfo(
      ...
      season: '🌊 Akhet – Season of Inundation',
      month:
          'Hathor (Tepy-a Kenmet) — Hathor, "House of Horus," golden cow whose body is the sky, patron of joy that heals',
      decanName: 'sꜣḥ ("Sah")',
      starCluster: '✨ Sah — stability regained.',
      maatPrinciple: 'You Lived. Honor That.',
      cosmicContext:
          '''The flood tested you. Paopi demanded carrying, distributing, protecting, auditing.
...
This day is sacred because you're still here.''',
      decanFlow: [
        ...
        DecanDayInfo(
          ...
          reflection:
              '"Does my daily space reflect the life I say I\'m living?"',
        ),
        DecanDayInfo(
          day: 6,
          theme: 'Warm the Bonds',
          action:
              'Reconnect gently with close people (family, partner, child, friend) without agenda.',
          reflection:
        ...
        DecanDayInfo(
          ...
          action:
              'Make or share something beautiful (meal, words, care, style, scent) as an offering, not a flex.',
          reflection:
        ...
        DecanDayInfo(
          ...
          action:
              'Bring your duties back online — but in rhythm, not panic. Rebuild routine that honors both output and well-being.',
        ...
        DecanDayInfo(
          ...
          action:
              'Check self-image. Release shame stories from survival mode. Carry yourself like Hathor: dignified, vibrant, whole.',
        ...
        DecanDayInfo(
          ...
          action:
              'Gratitude ritual: thank body, land, helpers, ancestors, Source. Mark survival as sacred, not accidental.',
          reflection: '"Who/what held me up while I was in the flood?"',
        ),
      ],
      meduNeter: MeduNeterKey(
        glyph:
            'ḥwt-ḥr (𓉗𓅃) — "House of Horus," the womb/temple that shelters light',
        colorFrequency:
            'Warm gold over fertile black earth — joy returning to a world that just survived chaos',
    ...
    'hathor_2_1': KemeticDayInfo(
      ...
      cosmicContext:
          '''Hathor is not only cosmic cow; she's tenderness made structural.
...
You can't pour beauty into the world if you're clenched and starving.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            '𓂝 (uplifted arm / vitality) inside ḥwt (enclosure/house) — "the body protected"',
        colorFrequency:
            'Milk white and warm gold — nourishment and sun on skin',
...
This is "make the lane walkable."''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'sweeping arm 𓂣 clearing before ḥwt (house) — "prepare the threshold"',
        colorFrequency:
            'Fresh earth brown and lotus green — cleaned ground, ready to receive life',
    ...
    'hathor_4_1': KemeticDayInfo(
      ...
      cosmicContext:
          '''Pleasure in Hathor's month is not "treat yourself and forget the world."
...
That was maintenance of spirit.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'mirror/sistrum energy (Hathor\'s rattle) — joy as sacred instrument, not distraction',
...
You are literally rebuilding your temple.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            '𓉐 (house / sacred enclosure) under Hathor\'s name — "the house as shrine"',
...
Connection itself was seen as medicine to the land.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'two arms embracing 𓂝𓂝 around a heart/offering — held, not alone',
...
Your softness can be someone else's survival point.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'offering arms 𓊤 lifting a lotus 𓆸 — "I raise beauty to the world"',
    ...
    'hathor_8_1': KemeticDayInfo(
      ...
      cosmicContext:
          '''Day 8 is where routine starts again — but you refuse to re-enter grind mode like nothing happened.
...
This is "structure my rhythm so I don't collapse."''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'working arm 𓂡 paired with Hathor\'s standard 𓉗𓅃 — labor under protection, not under abuse',
    ...
    'hathor_9_1': KemeticDayInfo(
      ...
      cosmicContext:
          '''In survival mode, you shrink. You get practical, grim, efficient. You feel "dirty," "tired," "less than."
...
Radiance is proof that life is still flowing.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Hathor\'s face in mirror (sacred mirror iconography), reflecting light back without apology',
...
Joy is earned survival, honored.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            '𓊤 (offering arms raised) + lotus 𓆸 + ḥwt-ḥr sign — thanksgiving lifted toward the golden cow of the sky',
        colorFrequency:
            'Honey gold, lotus blue, fertile black earth — joy anchored in survival and land',
    ...
    'hathor_11_2': KemeticDayInfo(
      ...
      cosmicContext:
          '''The first Hathor decan (ḫntt ẖrt) was you returning to your body, your home, your worth.
...
In Kemet, this is the moment crews actually formed to rebuild channels and repair granaries after flood stress. The bond was spoken out loud.''',
      decanFlow: [
        DecanDayInfo(
          ...
          action:
              'Say clearly who you\'re building with right now (family, crew, partner, teammate). Declare "we," not just "me."',
          reflection: '"Who is actually walking next to me?"',
        ),
        DecanDayInfo(
          day: 12,
          theme: 'Sync the Rhythm',
          action:
              'Align pace, schedules, expectations. Talk tempo: when do we move, rest, check in.',
          reflection: '"Are we moving in sync or stepping on each other?"',
        ),
        DecanDayInfo(
          day: 13,
          theme: 'Share the Load Fairly',
          action:
              'Divide tasks and emotional weight so one person isn\'t secretly carrying everything.',
          reflection:
              '"Where am I letting \'love\' or \'duty\' become exploitation?"',
        ),
        DecanDayInfo(
          day: 14,
          theme: 'Keep Honesty in Friction',
          action:
              'When tension shows up, address it cleanly, early, without poison.',
          reflection:
              '"Can I say what\'s not working without attacking who I love?"',
        ),
        DecanDayInfo(
          day: 15,
          theme: 'Repair the Commons',
          action:
              'Work together on shared infrastructure: house, money flow, workspace, calendar, kids\' routine, food system.',
          reflection:
              '"What shared system needs fixing so both of us can breathe?"',
        ),
        DecanDayInfo(
          day: 16,
          theme: 'Pledge Mutual Protection',
          action:
              'Make it explicit: I protect you in rooms you\'re not in. You protect me in rooms I\'m not in.',
          reflection:
              '"Do we defend each other\'s dignity when the other isn\'t there?"',
        ),
        DecanDayInfo(
          day: 17,
          theme: 'Honor the Work Done Together',
          action: 'Celebrate cooperative wins, not just solo heroics.',
          reflection: '"Do we name and praise what we built side-by-side?"',
        ),
        DecanDayInfo(
          day: 18,
          theme: 'Refine the System Together',
          action:
              'Adjust the plan so it\'s sustainable for both/all going forward. Shared optimization.',
          reflection:
        ...
        DecanDayInfo(
          ...
          action:
              'Rest together without guilt. Shared stillness, not just shared grind.',
          reflection:
              '"Can we be peaceful in the same room without performing?"',
        ),
        DecanDayInfo(
          day: 20,
          theme: 'Reaffirm the Bond to Ma\'at',
          action:
              'Speak gratitude for the partnership itself. Say: this bond is part of balance, not an accident.',
          reflection:
              '"Do we both understand this isn\'t casual — this is sacred alignment work?"',
        ),
      ],
      meduNeter: MeduNeterKey(
        glyph:
            'two walking figures side by side 𓂝𓂝 beneath one standard — "companions under one purpose"',
        colorFrequency:
            'Twin gold lines on rich earth brown — partnership grounded in real work',
...
In Kemet, this kept households from collapsing.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'load-bearing pole balanced across two shoulders — literal two-person carry bar',
        colorFrequency:
            'Paired earth-brown silhouettes under shared band of gold',
    ...
    'hathor_14_2': KemeticDayInfo(
      ...
      cosmicContext:
          '''Day 14 is the conversation nobody wants to have until it's already toxic.
...
Harmony is not silence. Harmony is clean truth early.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            '𓂋 (truth spoken) between two figures — "truth placed between us, not used against us"',
        colorFrequency:
            'Gold line between two bodies, not cutting them apart but linking them cleanly',
...
If somebody slanders you, that can cost food.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'protective arm curved around another figure (embrace / shielding gesture) under a shared standard',
...
It bonded crews so they'd keep showing up.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'joined hands / clasped wrists symbolizing alliance (classic mutual-aid posture in reliefs)',
...
In Kemet, this is how you prevent next month's crisis.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'straight measuring cord / plumb line held by two hands — cooperative alignment',
...
You're negotiating with them.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'two seated figures at ease under one roof/enclosure 𓉐 — shared sanctuary',
        colorFrequency:
            'Lotus blue and warm clay brown — calm, grounded companionship',
...
Your house? Your money system? Your creative work? Your body discipline? Your app? Your altar? Say it.''',
      decanFlow: [
        DecanDayInfo(
          ...
          action:
              'Declare one thing you\'re going to actually make, fix, or establish in the physical world.',
          reflection: '"What structure am I about to leave behind me?"',
        ),
        DecanDayInfo(
          day: 22,
          theme: 'Lay the Ground / Foundation',
          action:
              'Begin groundwork. Clear site, gather tools, source materials, set base rules or outline.',
          reflection:
              '"Did I prepare the ground so it can hold what I\'m about to raise?"',
        ),
        DecanDayInfo(
          day: 23,
          theme: 'Shape the Raw Material',
          action:
              'Mold clay, sketch the plan, draft the framework, cut the wood, write the first bones.',
          reflection: '"Can I start forming this without judging it yet?"',
        ),
        DecanDayInfo(
          day: 24,
          theme: 'Raise the First Form',
          action:
              'Put up the first visible piece. First wall, first interface, first habit in public reality.',
          reflection:
              '"Is it standing in the real world yet, even in rough form?"',
        ),
        DecanDayInfo(
          day: 25,
          theme: 'Carve the Meaning In',
          action:
              'Add intentional symbolism: blessing, inscription, stated purpose. Make sure it\'s not empty structure.',
          reflection:
              '"Does this thing reflect my values, or is it just \'productive\'?"',
        ),
        DecanDayInfo(
          day: 26,
          theme: 'Stabilize the Build',
          action:
              'Reinforce joints, seal leaks, tighten money flow, lock permissions, secure boundaries.',
          reflection:
              '"Where could this fall apart if I don\'t shore it up now?"',
        ),
        DecanDayInfo(
          day: 27,
          theme: 'Beautify With Purpose',
          action:
              'Refine surface: finish, aesthetic, scent, color, polish, the welcoming layer. Not vanity — invitation.',
          reflection: '"Is it pleasing to enter, to hold, to use?"',
        ),
        DecanDayInfo(
          day: 28,
          theme: 'Consecrate / Dedicate',
          action:
              'Offer it up. Mark the build as sacred. Thank whoever helped. Thank the Source that allowed it.',
          reflection: '"Who/what am I acknowledging as co-creator here?"',
        ),
        DecanDayInfo(
          day: 29,
          theme: 'Integration Into Daily Life',
          action: 'Fold it into your normal rhythm. Use it. Let it serve.',
          reflection:
              '"Is this now part of how I live — or is it just a nice idea sitting in a corner?"',
        ),
        DecanDayInfo(
          day: 30,
          theme: 'Witness and Record',
          action:
              'Document what was created: photos, notes, receipts, agreements, first usage. Claim it as real legacy, not a moment.',
          reflection:
              '"If I disappeared tomorrow, could someone see this and know who I was and what I served?"',
        ),
      ],
      meduNeter: MeduNeterKey(
        glyph:
            'mason\'s hand with tool against a rising block — deliberate shaping',
        colorFrequency:
            'Clay red and steady gold — earth lifted toward divine order',
...
Hathor might be pleasure, but she's not casual. She's honest craft.''',
      ...
      meduNeter: MeduNeterKey(
        ...
        colorFrequency:
            'Wet earth brown, leveled and ready, under a thin line of bright gold',
...
Rough is fine. We are out of theory now.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'upright pillar being raised by hands — stability entering the world',
        colorFrequency:
            'Stone grey kissed with gold at the top — unfinished but undeniable',
...
Beauty makes people want to enter and keep using the thing, which keeps it alive.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'perfume jar / cosmetic palette offered upward to the gods (classic Hathor offering scene)',
...
You acknowledge Source. You mark the build as sacred, not disposable.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'arms raised in offering 𓊤 over a finished pillar — "I lift this to the divine"',
...
This is evidence that order was restored in your lifetime.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'scribe\'s palette and papyrus roll beside the finished pillar — the act of recording the build as sacred memory',
    ...
    'kaherka_1_1': KemeticDayInfo(
      ...
      month:
          'Ka-ḥer-ka ("Ka upon Ka," doubling of life-force; resurrection through planting)',
      decanName: 'msḥtjw ("The Foreleg")',
      starCluster: '✨ The Foreleg — renewed strength.',
      maatPrinciple: 'Enter Stillness',
      cosmicContext:
          '''Day 1 is the pause after loss. The Nile has pulled back and the black earth (kemet) lies soft and exposed. The people lower their voices. The temples dim their music.
...
Maʿat in this phase is not movement — it's honoring what has passed without pretending you're fine.''',
      decanFlow: [
        DecanDayInfo(
          day: 1,
          theme: 'Enter Stillness',
          action: 'Pause unnecessary motion; let noise drain away.',
          reflection: '"What within me needs silence before it can rise?"',
        ),
        DecanDayInfo(
          day: 2,
          theme: 'Cleanse the Altar',
          action: 'Wash and clear old offerings, tools, clutter, stale energy.',
          reflection: '"What remnants of past harvests block renewal?"',
        ),
        DecanDayInfo(
          day: 3,
          theme: 'Name the Loss',
          action: 'Acknowledge what ended — say it without spin or denial.',
          reflection: '"Can I bless what left without bitterness?"',
        ),
        DecanDayInfo(
          day: 4,
          theme: 'Hold Memory',
          action:
              'Set out one token (photo, item, name) in respect, not obsession.',
          reflection: '"What good did this bring that still feeds me?"',
        ),
        DecanDayInfo(
          day: 5,
          theme: 'Ground the Body',
          action:
              'Touch the earth, breathe deep, eat something simple and real.',
          reflection: '"Am I anchored in the living world?"',
        ),
        DecanDayInfo(
          day: 6,
          theme: 'Watch the Sky',
          action: 'Look to the west before dawn; note the faint twin lights.',
          reflection: '"What pattern returns even in darkness?"',
        ),
        DecanDayInfo(
          day: 7,
          theme: 'Soft Speech Only',
          action: 'Speak kindly or not at all today. Tone is ritual.',
          reflection: '"Does my voice restore order or fracture it?"',
        ),
        DecanDayInfo(
          day: 8,
          theme: 'Tend the Seed',
          action:
              'Prepare soil (literal or symbolic). Ready something to plant.',
          reflection: '"What is ready to be buried, not abandoned?"',
        ),
        DecanDayInfo(
          day: 9,
          theme: 'Trust the Hidden Work',
          action: 'Accept that growth can begin in darkness, out of sight.',
          reflection:
              '"Can I believe life is rebuilding even if I can\'t prove it yet?"',
        ),
        DecanDayInfo(
          day: 10,
          theme: 'Seal the Chamber',
          action: 'Close the vigil. Dim lights early. Let it rest.',
          reflection:
              '"Have I allowed the old self to lay down so a new self can rise?"',
        ),
      ],
      meduNeter: MeduNeterKey(
        glyph:
            'Two outstretched arms embracing/protecting — containment and care',
        colorFrequency:
            'Black Nile silt with a thin silver line of dawn starlight',
...
You speak as if the room is sacred, because it is.''',
      ...
      meduNeter: MeduNeterKey(
        ...
        colorFrequency:
            'Muted gold and deep indigo (lamp light in a quiet house)',
...
By sealing, you create the condition for resurrection.''',
      ...
      meduNeter: MeduNeterKey(
        ...
        colorFrequency:
            'Darkened room brown with a rim of dawn gold at the threshold',
    ...
    'kaherka_11_2': KemeticDayInfo(
      ...
      season: '🌿 Peret – Season of Emergence',
      month:
          'Ka-ḥer-ka ("Ka upon Ka," doubled life-force, resurrection through burial and growth)',
...
You're allowed to stand before you're "over it."''',
      decanFlow: [
        DecanDayInfo(
          ...
          theme: 'Stand Back Up',
          action:
              'Re-enter movement. Choose one responsibility you resume today.',
          reflection:
              '"Where can I rise without pretending I don\'t still hurt?"',
        ),
        DecanDayInfo(
          day: 12,
          theme: 'Reclaim Your Name',
          action: 'Say your name, your role, your purpose out loud.',
          reflection: '"Who am I — even after what happened?"',
        ),
        DecanDayInfo(
          day: 13,
          theme: 'Feed What\'s Returning',
          action:
              'Give energy (time, food, money, protection, attention) to something that\'s trying to live again in your world.',
          reflection: '"Am I nurturing revival, or starving it?"',
        ),
        DecanDayInfo(
          day: 14,
          theme: 'Accept Sacred Obligation',
          action:
              'Acknowledge you are again responsible for someone / something (child, craft, house, land, self).',
          reflection: '"What is now mine to guard?"',
        ),
        DecanDayInfo(
          day: 15,
          theme: 'Speak Protection Over It',
          action:
              'Guard your rising the way Aset (Isis) guarded Asar (Osiris): "No harm will take you while I breathe."',
          reflection: '"Do I defend what I love in word and act?"',
        ),
        DecanDayInfo(
          day: 16,
          theme: 'Organize the Living',
          action:
              'Re-establish order in basics — time, food, money, sleep, cleanliness.',
          reflection: '"Does my daily rhythm honor life, or exhaust it?"',
        ),
        DecanDayInfo(
          day: 17,
          theme: 'Ask for Help Without Shame',
          action:
              'Call in assistance (like Nebet-Het (Nephthys) supporting Aset (Isis)). No isolation pride.',
          reflection:
              '"Where am I pretending I can do this alone and silently drowning?"',
        ),
        DecanDayInfo(
          day: 18,
          theme: 'Re-Enter Community',
          action:
              'Reconnect with one circle (household, crew, temple, flow community).',
          reflection: '"Where do I belong that I\'ve been avoiding?"',
        ),
        DecanDayInfo(
          day: 19,
          theme: 'Let Growth Be Visible',
          action:
              'Show one sign of recovery in public space. Let someone witness that you are coming back.',
          reflection: '"Am I allowing others to witness my return to life?"',
        ),
        DecanDayInfo(
          day: 20,
          theme: 'Give Thanks for Endurance',
          action: 'Offer gratitude not for perfection, but for survival.',
...
No. You pick up what is yours to guard.''',
      ...
      meduNeter: MeduNeterKey(
        ...
        colorFrequency:
            'Deep green of living Asar (Osiris) and protective linen white',
...
You say thank you to the part of you that refused to disappear.''',
      ...
      meduNeter: MeduNeterKey(
        ...
        colorFrequency:
            'Deep green of living Asar (Osiris) lit with steady lantern gold',
...
Your labor today is not "chores." It's priest-work. Treat it like that.''',
      decanFlow: [
        DecanDayInfo(
          ...
          action:
              'Approach daily labor as offering. Align intention with function.',
          reflection: '"Am I rowing in rhythm with heaven?"',
        ),
        DecanDayInfo(
          day: 22,
          theme: 'Reopen the Flow',
          action:
              'Clear blockages — physical, emotional, financial, spiritual.',
          reflection: '"Where has the canal of my life silted shut?"',
        ),
        DecanDayInfo(
          day: 23,
          theme: 'Raise the Pillar',
          action:
              'Restore foundation. In Kemet this meant lifting the Djed — stability itself.',
          reflection: '"What will I stand upright again in my world?"',
        ),
        DecanDayInfo(
          day: 24,
          theme: 'Restore the Home',
          action: 'Sweep, mend, rebuild, reset — your dwelling is your temple.',
          reflection: '"Does my space reflect balance or neglect?"',
        ),
        DecanDayInfo(
          day: 25,
          theme: 'Feed the Fire',
          action: 'Relight hearths, resume warmth and creation.',
          reflection: '"What flame must I tend to keep light in my life?"',
        ),
        DecanDayInfo(
          day: 26,
          theme: 'Anchor Community',
          action: 'Coordinate with others — shared meals, shared purpose.',
          reflection: '"Who rows beside me in this phase of renewal?"',
        ),
        DecanDayInfo(
          day: 27,
          theme: 'Celebrate Endurance',
          action:
              'Mark that you made it through the dark. Joy is not extra — it\'s fuel.',
          reflection: '"Do I allow myself to honor survival as sacred?"',
        ),
        DecanDayInfo(
          day: 28,
          theme: 'Offer Gratitude in Motion',
          action: 'Work and thank simultaneously. Labor itself is prayer.',
          reflection: '"Am I remembering Source while I act?"',
        ),
        DecanDayInfo(
          day: 29,
          theme: 'Synchronize with the Sun',
          action:
              'Align your rhythm with daylight. Rise, act, and rest in honest timing.',
          reflection:
              '"Is my pattern aligned with life, or am I fighting the current?"',
        ),
        DecanDayInfo(
          day: 30,
          theme: 'Seal the Cycle',
          action:
              'Close this phase with order, record, blessing. Claim what was restored.',
          reflection:
              '"What am I formally carrying into the next month of my life?"',
        ),
      ],
      meduNeter: MeduNeterKey(
        glyph:
            'Oar beneath the solar disk — the mortal hand rowing divine light forward',
...
In you, an unprepared life wastes blessing.''',
      decanFlow: [
        DecanDayInfo(
          day: 1,
          theme: 'Form the Vessel',
          action:
              'Prepare the container: clean jars, steady routines, clear a place for what will grow.',
          reflection: '"Have I shaped a stable place for life to sit?"',
        ),
        DecanDayInfo(
          day: 2,
          theme: 'Moisten the Clay',
          action: 'Water deliberately. Hydrate body, soil, schedule.',
          reflection:
              '"Where am I cracked from neglect and in need of moisture?"',
        ),
        DecanDayInfo(
          day: 3,
          theme: 'Plant Intention',
          action:
              'Choose one living goal this cycle and plant it. Not ten. One.',
          reflection: '"What deserves to be rooted in me right now?"',
        ),
        DecanDayInfo(
          day: 4,
          theme: 'Feed What You Planted',
          action: 'Give it fuel: calories, time, presence, protection.',
          reflection: '"Did I actually nourish what I claimed I cared about?"',
        ),
        DecanDayInfo(
          day: 5,
          theme: 'Protect the Fragile',
          action: 'Put small boundaries around early growth.',
          reflection: '"What new growth needs shielding from noise and chaos?"',
        ),
        DecanDayInfo(
          day: 6,
          theme: 'Breathe Into the Work',
          action: 'Slow the nervous system. Long exhale. Labor without panic.',
          reflection:
              '"Is my body still acting like I\'m in crisis even though I\'m not?"',
        ),
        DecanDayInfo(
          day: 7,
          theme: 'Honor the Providers',
          action: 'Acknowledge who/what nourishes you materially.',
          reflection:
              '"Do I treat my sources of support as sacred or as automatic?"',
        ),
        DecanDayInfo(
          day: 8,
          theme: 'Distribute Fairly',
          action:
              'Share food, money, time, attention in balance — not hoarding, not self-erasure.',
          reflection: '"Is my giving Ma\'at-balanced or am I draining myself?"',
        ),
        DecanDayInfo(
          day: 9,
          theme: 'Record the Yield',
          action:
              'Take inventory. What did you actually grow, save, repair, stabilize so far?',
          reflection:
              '"Can I point to proof of order — or am I telling a story?"',
        ),
        DecanDayInfo(
          day: 10,
          theme: 'Seal the Promise to Continue',
          action: 'Make a quiet vow to keep feeding this life tomorrow.',
          reflection: '"What will I keep alive through consistency, not hype?"',
        ),
      ],
      meduNeter: MeduNeterKey(
        glyph:
...
Your job is to commit to something that deserves to live in you, and press it gently into the soil.''',
    ...
    'sefbedet_4_1': KemeticDayInfo(
      ...
      season: '🌿 Peret – Season of Emergence',
      month:
          'Šef-Bedet — The month where feeding is civilization\'s first duty.',
      decanName: 'sbꜣ ḫnty-ḥr ("Star of the Foremost")',
      starCluster: '✨ Star of the Foremost — trusted growth.',
...
Renenutet's gaze was considered mercy because it caught the threat early. You do the same. You do not look away.''',
      decanFlow: [
        DecanDayInfo(
          day: 11,
          theme: 'Walk the Boundary',
          action:
              'Inspect the perimeter of your life: health, money, relationships, space. Note every breach.',
          reflection: '"Where is chaos sneaking in?"',
        ),
        DecanDayInfo(
          day: 12,
          theme: 'Name the Pest',
          action:
              'Identify the actual drain (person, habit, substance, thought) without lying about it.',
          reflection: '"What is quietly eating my field at night?"',
        ),
        DecanDayInfo(
          day: 13,
          theme: 'Lay Protective Offerings',
          action:
              'Strengthen the guard: rituals, nutrition, sleep, locks, agreements, budgeting, passwords.',
          reflection:
              '"What will I put in place tonight so I wake safer tomorrow?"',
        ),
        DecanDayInfo(
          day: 14,
          theme: 'Strike the Threat',
          action:
              'Remove what actively harms growth. Cut access. Say no. Block.',
          reflection:
              '"What am I allowing near me that Ma\'at would drive into the sand?"',
        ),
        DecanDayInfo(
          day: 15,
          theme: 'Cool the Field',
          action:
              'Lower heat before it scorches: de-escalate conflict, reduce stress load, cool inflammation.',
          reflection: '"Where am I running too hot to stay fertile?"',
        ),
        DecanDayInfo(
          day: 16,
          theme: 'Guard the Storehouse',
          action:
              'Protect stored value: food, money, saved energy, repaired trust.',
          reflection: '"What I saved — is it actually safe?"',
        ),
        DecanDayInfo(
          day: 17,
          theme: 'Tighten the Circle',
          action:
              'Reconfirm who is inside your protected space and who is not.',
          reflection: '"Who has access to me that should not?"',
        ),
        DecanDayInfo(
          day: 18,
          theme: 'Track the Losses',
          action: 'Record leaks, waste, theft, relapse, erosion. No denial.',
          reflection: '"Where did life escape my hands?"',
        ),
        DecanDayInfo(
          day: 19,
          theme: 'Reinforce the Oath',
          action:
              'Restate your terms: how you will be treated, how resources will be handled, how peace is kept.',
          reflection: '"Have I spoken my law out loud?"',
        ),
        DecanDayInfo(
          day: 20,
          theme: 'Stand Watch at Dusk',
          action:
              'End the decan in awareness. Quiet body, sharpen perception. Stay awake to patterns.',
          reflection:
              '"Do I see threats early enough, or only after damage is done?"',
        ),
      ],
      meduNeter: MeduNeterKey(
    ...
    'sefbedet_12_2': KemeticDayInfo(
      ...
      season: '🌿 Peret – Season of Emergence',
      month:
          'Šef-Bedet — The month where nourishment becomes a social contract.',
      decanName: 'sbꜣ ḫnty-ḥr ("Star of the Foremost")',
      starCluster: '✨ Star of the Foremost — trusted growth.',
...
Trust is part of Ma'at. Panic forever is not.''',
      decanFlow: [
        DecanDayInfo(
          day: 21,
          theme: 'Exhale the Tension',
          action:
              'Let the body unclench. Rest nervous systems you\'ve been holding tight.',
          reflection:
              '"Where am I still braced for danger that has already passed?"',
        ),
        DecanDayInfo(
          day: 22,
          theme: 'Acknowledge the Living Field',
          action:
              'Look directly at what you\'ve kept alive — family, body, work, order. Witness it without minimizing.',
          reflection: '"What survived because of my care?"',
        ),
        DecanDayInfo(
          day: 23,
          theme: 'Bless What Will Feed Others',
          action: 'Offer gratitude for what will nourish more than just you.',
          reflection: '"Who will be fed by what I\'ve protected?"',
        ),
        DecanDayInfo(
          day: 24,
          theme: 'Loosen Control (Without Abandoning Order)',
          action: 'Release micromanaging. Trust the processes you\'ve built.',
          reflection:
              '"Where can I stop gripping and let Ma\'at carry some of the weight?"',
        ),
        DecanDayInfo(
          day: 25,
          theme: 'Tend the Vessel',
          action:
              'Care for the carrier — your own body, your tools, your hands, your voice.',
          reflection:
              '"Am I maintaining the vessel that delivers nourishment?"',
        ),
        DecanDayInfo(
          day: 26,
          theme: 'Name the Inheritance',
          action:
              'Say clearly what will be passed forward — knowledge, rhythm, safety, stored grain, example.',
          reflection: '"What am I preparing to hand to the next set of hands?"',
        ),
        DecanDayInfo(
          day: 27,
          theme: 'Give Thanks Without Apology',
          action:
              'Give thanks openly, without shrinking or performing humility.',
          reflection: '"Can I receive the reality that I did sacred work?"',
        ),
        DecanDayInfo(
          day: 28,
          theme: 'Bind the Promise',
          action: 'State your continuation vow: "This order will continue."',
          reflection:
              '"What balance will I refuse to let collapse after today?"',
        ),
        DecanDayInfo(
          day: 29,
          theme: 'Align with Graceful Pace',
          action: 'Match your movement to sustainable rhythm, not panic speed.',
          reflection: '"Is my current tempo survivable long-term?"',
        ),
        DecanDayInfo(
          day: 30,
          theme: 'Prepare the Hand-Off',
          action:
              'Close the month not in exhaustion, but in readiness to begin the next cycle with dignity intact.',
          reflection:
              '"How do I enter the next month as keeper, not as casualty?"',
        ),
      ],
      meduNeter: MeduNeterKey(
        glyph:
            'Long serpent stretched in a relaxed curve around a planted field',
...
This is how Kemet stayed standing for millennia: each cycle did not just end — it prepared the next one with dignity.''',
      ...
      meduNeter: MeduNeterKey(
        ...
        mantra:
            '"I do not just survive the cycle — I hand it forward in order."',
      ),
    ),
    ...
    'rekhwer_1_1': KemeticDayInfo(
      ...
      month:
          'Rekh-Wer (rḫ-wr) — "Great Knowing," the month where knowledge becomes duty, not ego',
...
You are not waiting for someone else to be the adult. You are the adult.''',
      decanFlow: [
        DecanDayInfo(
          day: 1,
          theme: 'Wake to Responsibility',
          action:
              'Rise with purpose. Accept that keeping order is your role now.',
          reflection: '"What in my world answers to me?"',
        ),
        DecanDayInfo(
          day: 2,
          theme: 'Walk the Perimeter',
          action:
              'Inspect physical, emotional, financial, and spiritual boundaries. Look for breaches.',
          reflection:
              '"Where is something crossing a line without permission?"',
        ),
        DecanDayInfo(
          day: 3,
          theme: 'Name What\'s Off',
          action:
              'Say out loud what is out of balance — no softening, no pretending.',
          reflection: '"Where am I lying to myself about the state of things?"',
        ),
        DecanDayInfo(
          day: 4,
          theme: 'Correct the Channel',
          action:
              'Make one direct adjustment (repair, repay, re-say, re-mark a line).',
          reflection:
              '"What small fix today prevents a larger problem tomorrow?"',
        ),
        DecanDayInfo(
          day: 5,
          theme: 'Account for the Store',
          action:
              'Count what is actually there — money, energy, grain, time, attention. No fantasy math.',
          reflection: '"What do I truly have, not what I wish I had?"',
        ),
        DecanDayInfo(
          day: 6,
          theme: 'Stabilize the Schedule',
          action:
              'Align today\'s time blocks with what matters most, not noise.',
          reflection: '"Is my day shaped by intention or by interruption?"',
        ),
        DecanDayInfo(
          day: 7,
          theme: 'Cut Hidden Waste',
          action:
              'Identify one leak: energy drain, money drain, attention drain. Seal it.',
          reflection: '"Where am I bleeding out and calling it normal?"',
        ),
        DecanDayInfo(
          day: 8,
          theme: 'Reinforce Authority with Calm',
          action:
              'Re-state a boundary without anger. Calm is not weakness — it\'s proof of control.',
          reflection: '"Can I assert order without shouting?"',
        ),
        DecanDayInfo(
          day: 9,
          theme: 'Teach the Rule',
          action:
              'Tell someone who depends on you what the rule is and why. Pass on structure like inheritance.',
          reflection:
              '"Did I explain the \'why,\' or am I expecting obedience without understanding?"',
        ),
        DecanDayInfo(
          day: 10,
          theme: 'Document the State of the House',
          action:
              'Record conditions: resources, risks, supports, goals. This becomes the baseline for the rest of the month.',
          reflection:
              '"If I vanished tonight, would someone know where things stand because I wrote it down?"',
        ),
      ],
      meduNeter: MeduNeterKey(
...
This is not paranoia. This is care.''',
    ...
    'rekhwer_3_1': KemeticDayInfo(
      ...
      season: '🌿 Peret – Season of Emergence',
      month:
          'Rekh-Wer — rḫ-wr, "Great Knowing," meaning not trivia but correct perception',
      decanName: 'knmw ("Khnum")',
      starCluster: '✨ Khnum — formation through knowledge.',
...
You're not "being dramatic." You're preventing flood damage of the soul.''',
    ...
    'rekhwer_5_1': KemeticDayInfo(
      ...
      season: '🌿 Peret – Season of Emergence',
      month:
          'Rekh-Wer — rḫ-wr, "Great Knowing," guided by Thoth and tempered by Sekhmet',
      decanName: 'knmw ("Khnum")',
      starCluster: '✨ Khnum — formation through knowledge.',
...
You are allowed to seal that tear without guilt. That is not selfishness. That is duty to the household you protect.''',
    ...
    'rekhwer_8_1': KemeticDayInfo(
      ...
      season: '🌿 Peret – Season of Emergence',
      month:
          'Rekh-Wer — Great Knowing under Thoth\'s measure and Sekhmet\'s fire',
      decanName: 'knmw ("Khnum")',
      starCluster: '✨ Khnum — formation through knowledge.',
...
Your memory should not be the only place your world exists.''',
    ...
    'rekhwer_11_2': KemeticDayInfo(
      ...
      month:
          'Rekh-Wer (rḫ-wr) — "Great Knowing," the sober application of intelligence',
...
Your job today is simple: do not let your core fire scatter. Keep it centered so it can be used with intention and not spill into harm.''',
      decanFlow: [
        DecanDayInfo(
          day: 11,
          theme: 'Center the Fire',
          action:
              'Locate your driving force (anger, urgency, ambition, loyalty). Hold it steady instead of spraying it.',
          reflection: '"What is actually fueling me right now?"',
        ),
        DecanDayInfo(
          day: 12,
          theme: 'Breathe the Field',
          action:
              'Loosen what\'s suffocating. Aerate the space: open windows, let truth and air in.',
          reflection: '"Where in my life is something alive but gasping?"',
        ),
        DecanDayInfo(
          day: 13,
          theme: 'Act Without Fury',
          action: 'Do the necessary task firmly, without tantrum.',
          reflection: '"Can I move with authority without losing my face?"',
        ),
        DecanDayInfo(
          day: 14,
          theme: 'Align Power With Purpose',
          action:
              'Aim your strength at what matters, not whatever annoyed you first.',
          reflection:
              '"Is my effort feeding my purpose, or just feeding my irritation?"',
        ),
        DecanDayInfo(
          day: 15,
          theme: 'Maintain Heat, Don\'t Burn',
          action: 'Sustain energy at a livable temperature. Pace yourself.',
          reflection: '"Am I keeping a steady flame or am I scorching myself?"',
        ),
        DecanDayInfo(
          day: 16,
          theme: 'Speak Clean Command',
          action:
              'Issue one clear directive today. Short. Precise. Need-based, not ego-based.',
          reflection:
              '"Did I make the ask in clean language, or did I posture?"',
        ),
        DecanDayInfo(
          day: 17,
          theme: 'Carry Sun Into the Work',
          action:
              'Show up physically. Do visible labor that signals "I am part of this," not just "Do this for me."',
          reflection: '"Did I stand next to the work I\'m calling for?"',
        ),
        DecanDayInfo(
          day: 18,
          theme: 'Shield With Strength',
          action:
              'Use your position/voice/resources to protect someone or something more vulnerable.',
          reflection: '"Who needed my cover today — and did they get it?"',
        ),
        DecanDayInfo(
          day: 19,
          theme: 'Cool With Honor',
          action:
              'Enforce rest, shade, cooling, recovery as sacred — not laziness.',
          reflection: '"Do I guilt myself for needing restoration?"',
        ),
        DecanDayInfo(
          day: 20,
          theme: 'Oath of Restraint',
          action:
              'State, out loud, one line you will not cross with your power.',
          reflection:
              '"Where must I promise myself: \'I will not become the fire that harms what I love\'?"',
        ),
      ],
      meduNeter: MeduNeterKey(
...
Your words must become efficient tools, not weapons that spray resentment.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Mouth-sign above a straight vertical line (order spoken into place)',
    ...
    'rekhwer_17_2': KemeticDayInfo(
      ...
      season: '🌿 Peret – Season of Emergence',
      month:
          'Rekh-Wer — "Great Knowing," which includes knowing you are part of the labor, not above it',
      decanName: 'ḥry-ib knmw ("Heart of Khnum")',
      starCluster: '✨ Heart of Khnum — discerning, guided craft.',
...
This is the seal of the decan. This is how you prove you are not just strong — you are trustworthy.''',
    ...
    'rekhwer_21_3': KemeticDayInfo(
      ...
      month:
          'Rekh-Wer (rḫ-wr) — "Great Knowing," the discipline of applied understanding',
...
Maʿat is never impressed by denial. Maʿat is impressed by accuracy.''',
      decanFlow: [
        DecanDayInfo(
          day: 21,
          theme: 'Take Inventory',
          action:
              'Lay out your tools, habits, alliances, money, body, promises. See them clearly.',
          reflection: '"What do I actually have going into the next cycle?"',
        ),
        DecanDayInfo(
          day: 22,
          theme: 'Name the Damage',
          action:
              'Admit what\'s cracked, dull, corroded, exhausted, dishonest, or slipping.',
          reflection: '"Where am I pretending I\'m fine when I\'m not?"',
        ),
        DecanDayInfo(
          day: 23,
          theme: 'Sharpen the Edge',
          action:
              'Restore one instrument you will need: skill, body, gear, discipline.',
          reflection:
              '"What must be honed so I can cut cleanly instead of hacking?"',
        ),
        DecanDayInfo(
          day: 24,
          theme: 'Repair Alignment',
          action:
              'Bring something back into true: posture, schedule, agreement, budget, boundary.',
          reflection:
              '"What needs realignment so it doesn\'t fail under pressure?"',
        ),
        DecanDayInfo(
          day: 25,
          theme: 'Yoke the Bull',
          action:
              'Direct raw force into service, not dominance. Channel strength toward duty.',
          reflection:
              '"Is my power serving Maʿat, or just serving my appetite?"',
        ),
        DecanDayInfo(
          day: 26,
          theme: 'Set Obligation Clearly',
          action: 'State aloud what you are now responsible for maintaining.',
          reflection: '"What is mine to keep alive, no excuses?"',
        ),
        DecanDayInfo(
          day: 27,
          theme: 'Cut Loose the Rot',
          action:
              'Remove one attachment, behavior, or drain you cannot carry forward.',
          reflection: '"What will sabotage the harvest if I keep feeding it?"',
        ),
        DecanDayInfo(
          day: 28,
          theme: 'Swear Continuity',
          action:
              'Promise continuity of care: "I will continue tending this through the next phase."',
          reflection: '"What deserves my steady hand past today?"',
        ),
        DecanDayInfo(
          day: 29,
          theme: 'Submit to Measure',
          action:
              'Accept accountability. Record numbers, track progress, document truth without inflation.',
          reflection: '"Can I face the numbers without lying?"',
        ),
        DecanDayInfo(
          day: 30,
          theme: 'Present Yourself to Maʿat',
          action:
              'Stand as you are — sharpened, yoked, honest — and offer yourself as an instrument of balance going forward.',
          reflection:
              '"Am I prepared to be used in the work of order, not just praised for surviving the last cycle?"',
        ),
      ],
      meduNeter: MeduNeterKey(
...
This is the handover from survival to stewardship.''',
    ...
    'renwet_1_1': KemeticDayInfo(
      ...
      month:
          'Renwet (rnnt) — "The Month of Gratitude and Fate," overseen by Renenutet, She Who Nurtures into Being',
      decanName: 'sbꜣ knmw ("Star of Khnum")',
      starCluster: '✨ Star of Khnum — reliable, guiding skill.',
...
Ungrateful mouths were believed to poison their own fate.''',
      ...
      meduNeter: MeduNeterKey(
        ...
        mantra:
            '"I speak my thanks into the world so the world knows I honor it."',
      ),
    ),
...
You state aloud who you are committing to be with what you've been given. This is how fate is braided to behavior.''',
      ...
      meduNeter: MeduNeterKey(
        ...
        mantra:
            '"I accept the name destiny gave me — and I will act like it\'s mine."',
      ),
    ),
    ...
    'renwet_11_2': KemeticDayInfo(
      ...
      month:
          'Renwet (rnnt) — month of gratitude, fate, and accountability before Renenutet',
      decanName: 'sbꜣ knmw ("Star of Khnum")',
      starCluster: '✨ Star of Khnum — reliable, guiding skill.',
...
If you are resourced and someone close to you is still in danger, Maʿat demands you move.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Outstretched arm forming a protective curve over a seated child',
...
Completion is an offering.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Pair of uplifted hands releasing a sealed jar toward the rising sun line',
    ...
    'hnsw_1_1': KemeticDayInfo(
      ...
      month:
          'Hnsw ("The Traveler") — sacred motion, dignified endurance under Ra',
...
Movement without integrity is not sacred travel. It's looting.''',
      ...
      meduNeter: MeduNeterKey(
        ...
        mantra:
            '"My path is clean, so my name can move ahead of me without shame."',
      ),
    ),
...
You cannot poison the altar and expect blessing to follow.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Two hands exchanging a weighed bundle beneath the feather of Maʿat',
...
You are landing. Let yourself land.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Seated figure in profile, hands resting on knees, sun low behind',
...
You close Hnsw not by vanishing into rest, but by placing the journey in Maʿat and saying: It is complete.''',
    ...
    'henti_1_1': KemeticDayInfo(
      ...
      season: '☀️ Shemu — Heat and Distribution',
      month:
          'Ḥenti-ḥet ("Foremost of Offerings") — peace through giving back what you were given',
      decanName: 'sbꜣ knmw ("Star of Khnum")',
      starCluster: '✨ Star of Khnum — reliable, guiding skill.',
...
Efficiency is not greed here. It's reverence. You refuse to waste your life-force just to appear tireless.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Falcon standing with one raised talon — poised, not wasting motion',
...
You cannot offer yourself back to Maʿat shattered and call that devotion.''',
    ...
    'henti_10_1': KemeticDayInfo(
      ...
      season: '☀️ Shemu — Heat and Distribution',
      month:
          'Ḥenti-ḥet — "Foremost of Offerings," peace by returning what is not yours to keep',
      decanName: 'sbꜣ knmw ("Star of Khnum")',
      starCluster: '✨ Star of Khnum — reliable, guiding skill.',
...
Maʿat is not an idea. Maʿat is an oath you walk in public heat.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'The falcon of Horus standing before the sun disk with a vow-hand (palm forward) raised',
    ...
    'henti_11_2': KemeticDayInfo(
      ...
      season: '☀️ Shemu — Heat and Distribution',
      month:
          'Ḥenti-ḥet ("Foremost of Offerings") — peace through giving back and cooling excess',
      decanName: 'sbꜣ knmw ("Star of Khnum")',
      starCluster: '✨ Star of Khnum — reliable, guiding skill.',
...
In Kemet, that moment separated destroyers from protectors.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Sun disk held gently between two open hands instead of clenched fists',
    ...
    'henti_21_3': KemeticDayInfo(
      ...
      season: '☀️ Shemu — Heat and Distribution',
      month:
          'Ḥenti-ḥet ("Foremost of Offerings") — to give back is to create peace',
      decanName: 'sbꜣ knmw ("Star of Khnum")',
      starCluster: '✨ Star of Khnum — reliable, guiding skill.',
...
This is not quitting. This is intelligent survival under Ra.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Bent foreleg of a bull laid calmly on an altar, not in struggle',
...
Write it. Archive it. Put your restoration on record so Maʿat can point to it.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Scribe palette and reed pen beside a coiled rope (measured order)',
...
You close the month the way a priest closes the shrine: with dignity.''',
    ...
    'ipt_1_1': KemeticDayInfo(
      ...
      season: '☀️ Shemu — Heat and Distribution',
      month:
          'Ipt-ḥmt ("Bringing Together / Union") — reunion of living and ancestral lines, renewal through remembrance',
      decanName: 'sbꜣ knmw ("Star of Khnum")',
      starCluster: '✨ Star of Khnum — reliable, guiding skill.',
...
You are not alone. You never were.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Outstretched arms calling to a seated ancestor spirit (Ka arms raised)',
...
This is worship through loyalty.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Offering table with bread and water jars before a Ka-sign figure',
...
Guidance from those who survived before you is not theory. It is field-tested law.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Seated ancestor figure with one hand raised in speech and one hand over the heart',
...
Maʿat begins inside the doorway.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Two figures touching foreheads inside an enclosing protection loop',
...
The gods record. Your ancestors hear. You become answerable.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Ka-arms raised behind a kneeling supplicant before an offering table',
...
This is not guilt. This is calibration. You're checking your own weight while you're still alive enough to adjust.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Feather of Maʿat beside an open mouth (truth spoken under judgment)',
...
The honored dead hear you and hold you accountable.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Outstretched hand in a "stop" gesture beside the feather of Maʿat',
...
You do not pretend it wasn't there. You say, "I see it. It stops here."''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Eye of Horus (the restored eye) above the banded Djed of Asar (Osiris)',
...
When you declare it, the world can measure you by it. That pressure is holy.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Falcon standard raised upright before a pair of outstretched arms',
...
Now you stand upright and say: "I am here, in order, under Maʿat. I will carry."''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Falcon standing atop the Orion-standard, facing east toward sunrise',
        colorFrequency:
            'Horizon gold over night blue dissolving into pale dawn',
...
Stillness is not retreat. Stillness is preparation for reassembly.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Sah as a striding, star-marked figure of Asar (Osiris), outlined in constellation points',
        colorFrequency:
            'Deep midnight indigo, barely pierced by white fire points',
...
Lay it down for one day. See what remains of you when you are not busy defending.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Open palm releasing a blade to the ground before the Djed pillar',
        colorFrequency:
            'Matte black surrender with a single line of grounded brown',
...
Sah rises in silence so the nervous system of the land can follow.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'The hieroglyph for breath / air-lines rising before the nose of a seated figure',
...
To be reborn under Ra, you must first be fully present under Nut.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Outstretched hands over the seated human figure (gesture of protection and indwelling)',
...
This is how the next birth begins: not with perfection, but with truth placed in sacred hands.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Aset\'s knot (the tit) beside the Djed, union of holding and raising',
...
Say it out loud. The body hears you. The soul hears you. Maʿat hears you.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Name-ring / cartouche enclosing a ren, protected by a looped rope-oval',
        colorFrequency:
            'Bright declaration gold against matte black background',
...
You are not required to drag any of that into rebirth. You are allowed to say, "No further."''',
      ...
      meduNeter: MeduNeterKey(
        ...
        colorFrequency:
            'Night-guard charcoal with a single protective line of red at the threshold',
...
You are standing at the door of the next cycle as living structure, holding Maʿat in place until Ra crowns the sky.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'A sealed doorway with the Djed set before it like a pillar of oath',
        colorFrequency:
            'Horizon line of pale dawn gold against deep pre-sun violet',
...
Some things must break so they can be rebuilt on Maʿat.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'A foreleg of a bull with a fine fracture line and a small star above it',
        colorFrequency:
            'Deep indigo (night of unknowing) with bone white (truth revealed)',
...
This is inventory before resurrection.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'A papyrus scroll unrolled, with small fragment-marks along its length',
        colorFrequency:
            'Sand-gold (memory of the year) and ink black (clear naming)',
...
Something will stir.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Two outstretched arms drawing small fragments inward toward a central heart',
        colorFrequency:
            'Deep Nile blue (returning flow) with solar gold (summoning power)',
...
Day 25 is a blade — precise, clean, sacred.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'A ritual knife beside the feather of Maʿat, cutting away a small dark knot',
        colorFrequency:
            'Blade-silver and desert ochre (what is cut away and left behind)',
...
It prepares you for strength without brittleness.''',
      ...
      meduNeter: MeduNeterKey(
        ...
        colorFrequency:
            'Warm amber (healing oil) with soft rose-gold (tenderness)',
...
This day ensures your return will be durable.''',
      ...
      meduNeter: MeduNeterKey(
        ...
        colorFrequency:
            'Basalt black (endurance) and emerald green (rising strength)',
...
A sealed shape is a declaration.''',
      ...
      meduNeter: MeduNeterKey(
        ...
        colorFrequency:
            'Wax-gold (finalizing) over midnight blue (mystery held)',
...
You sit on your own restored throne.''',
      ...
      meduNeter: MeduNeterKey(
        ...
        colorFrequency:
            'Deep Osirian green with black-gold (sovereignty in stillness)',
...
Tomorrow, the world begins again.''',
    ...
    'epagomenal_1_1': KemeticDayInfo(
      ...
      cosmicContext:
          '''On this day, Nut labors for the first time, breaking Ra's decree that no child be born during the year.
...
This day whispers the core truth of Ma'at: nothing alive truly dies; it only transforms.''',
    ...
    'epagomenal_2_1': KemeticDayInfo(
      ...
      cosmicContext:
          '''Today Nut gives birth to Horus the Elder, the original sky-falcon whose eyes are sun and moon.
...
Let your internal sun rise.''',
    ...
    'epagomenal_3_1': KemeticDayInfo(
      ...
      cosmicContext:
          '''The third birth is Set, often misunderstood but essential: he is not evil; he is raw force without guidance.
...
You don't destroy life; you destroy what destroys life.''',
    ...
    'epagomenal_4_1': KemeticDayInfo(
      ...
      cosmicContext:
          '''Tonight Nut gives birth to Aset (Isis) — the mind and heart unified.
...
Aset teaches that order is restored not only by strength but by truth spoken from the center of the heart.''',
    ...
    'epagomenal_5_1': KemeticDayInfo(
      ...
      cosmicContext:
          '''On this final epagomenal day, Nut brings forth Nebet-Het (Nephthys) — guardian of thresholds, dusk, memory, and the quiet fields of the dead.
...
Tonight is the final breath of the old world.''',
    ...
    'rekhnedjes_1_1': KemeticDayInfo(
      ...
      season: '🌿 Peret — Season of Emergence',
      month:
          'Rekh-Nedjes (Pa-Menoth) — "Lesser Knowing," applied wisdom under trial',
      decanName: 'špsswt ("The Noble Ones")',
      starCluster: '✨ The Noble Ones — tested understanding.',
      maatPrinciple: 'Endurance Is Divine',
      cosmicContext:
          '''Rekh-Nedjes opens with Orion standing like a backbone in the sky, reminding the Kemite that true strength is quiet and sustained.
...
The heavens watch not for perfection, but for persistence.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Orion as a three-star belt forming a Djed-like spine in the southern sky',
    ...
    'rekhnedjes_2_1': KemeticDayInfo(
      ...
      cosmicContext:
          '''On Day 2, the lesson of Sah shifts from merely standing to aligning.
...
Ma'at is preserved not by sudden force, but by quiet precision.''',
    ...
    'rekhnedjes_3_1': KemeticDayInfo(
      ...
      cosmicContext:
          '''By Day 3, the excitement of "starting" fades, and the soul meets the real work of repetition.
...
Straightening a schedule, a boundary, or a habit is a sacred act; it is how you tell the cosmos you can be trusted with more power.''',
    ...
    'rekhnedjes_5_1': KemeticDayInfo(
      ...
      cosmicContext:
          '''By Day 5, the load of the month is fully on your shoulders.
...
You simply keep your form.''',
    ...
    'rekhnedjes_8_1': KemeticDayInfo(
      ...
      cosmicContext:
          '''On Day 8, the grandeur of the constellation fades into normalcy.
...
Sealed lessons become part of your Ka.''',
    ...
    'rekhnedjes_11_2': KemeticDayInfo(
      ...
      cosmicContext:
          '''Rekh-Nedjes now moves from solitary endurance to guidance.
...
You do not have to invent the road; you only have to walk it with care.''',
    ...
    'rekhnedjes_15_2': KemeticDayInfo(
      ...
      cosmicContext:
          '''By Day 15, the relationship with your teachers matures; they are no longer only correcting gross errors, but refining details.
...
In Lesser Knowing, such refinements are not vanity; they are devotion.''',
    ...
    'rekhnedjes_16_2': KemeticDayInfo(
      ...
      cosmicContext:
          '''Day 16 turns the current around: you move from only receiving wisdom to becoming one of the lights in sbꜣw.
...
Ma'at is preserved when each generation refuses to hoard its hard-won clarity.''',
    ...
    'rekhnedjes_17_2': KemeticDayInfo(
      ...
      cosmicContext:
          '''Day 17 widens the frame beyond personal mentors to the whole lineage that brought you here.
...
Recognizing lineage keeps humility alive; it reminds you that you are not the source, only the latest link.''',
    ...
    'rekhnedjes_18_2': KemeticDayInfo(
      ...
      cosmicContext:
          '''Not every bright thing in the sky is a trustworthy star; some are passing fires, some are illusions of the air.
...
Ma'at respects what you are willing to formalize.''',
    ...
    'rekhnedjes_21_3': KemeticDayInfo(
      ...
      season: '🌿 Peret — Season of Emergence',
      month:
          'Rekh-Nedjes (Pa-Menoth) — "Lesser Knowing," applied learning under trial',
...
This is how rest becomes safe instead of fragile.''',
    ...
    'rekhnedjes_23_3': KemeticDayInfo(
      ...
      cosmicContext:
          '''By the end of Rekh-Nedjes, fields were less demanding, but the work did not stop; it shifted inward.
...
Kemet knew: a clean tool is a quiet blessing.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Knife-blade with droplets of water above and a small spark at the tip',
    ...
    'rekhnedjes_24_3': KemeticDayInfo(
      ...
      cosmicContext:
          '''The disputes of Horus and Set were not only between gods; they were mirrors of the inner struggle between impulse and restraint, pride and humility, hurt and duty.
...
Inner peace is not fog; it is alignment.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Two hearts or lungs facing each other with a single feather between them',
    ...
    'rekhnedjes_25_3': KemeticDayInfo(
      ...
      cosmicContext:
          '''The trials of Horus and Set did not end in endless war; they ended in a negotiated order.
...
Maʿat does not require you to embrace danger; she does invite you to relieve what can be relieved, for your own spirit's sake.''',
    ...
    'rekhnedjes_26_3': KemeticDayInfo(
      ...
      cosmicContext:
          '''By now, the month has shown its lesson: knowing is nothing without endurance, and endurance is nothing without a rhythm the body and spirit can survive.
...
Maʿat is honored when reality — including your quiet strength — is fully seen.''',
    ...
    'rekhnedjes_28_3': KemeticDayInfo(
      ...
      cosmicContext:
          '''As Rekh-Nedjes closes, the people of Kemet did not add more; they pared back.
...
Simplifying is how you make room for the right light.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Basket with one item being lifted out and a feather remaining inside',
    ...
    'rekhnedjes_29_3': KemeticDayInfo(
      ...
      cosmicContext:
          '''On the penultimate day of Rekh-Nedjes, the Kemite looked ahead.
...
Peace does not arrive to a scattered table; it comes where there is room set aside for it.''',
      ...
      meduNeter: MeduNeterKey(
        ...
        colorFrequency:
            'Threshold stone grey with a band of soft gold at the edge',
    ...
    'rekhnedjes_30_3': KemeticDayInfo(
      ...
      cosmicContext:
          '''The month of Lesser Knowing ends not with a test, but with a Sabbath.
...
Let your body believe that peace is not a brief accident but a rightful state.''',
      ...
      meduNeter: MeduNeterKey(
        glyph:
            'Reclining figure beneath the Maʿat feather and a small sun set low on the horizon',
  ...
  static String calculateGregorianDate(String dayKey, {int? kYearParam}) {
    ...
    try {
      ...
      final DateTime gregorianUtc = KemeticMath.toGregorian(
        kYear,
        kMonth,
        kDay,
      );
